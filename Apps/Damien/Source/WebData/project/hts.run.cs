...
MongoCommand.Find("htc", "Unea_Detail", "{}", limit:10, fields: "{ 'data.Detail1.Name': 1, 'data.Detail2.Name': 1 }", sort: "{ _id: 1 }").zView();
...
TraceMongoCommand.Export("htc", "Handeco_Detail_2", Path.Combine(AppData.DataDirectory, @"sites\handeco.org\mongo\export_Handeco_Detail_2.txt"), sort: "{ _id: 1 }");

WebData.WebData.CreateHandeco().HeaderDetailManager.LoadDetails(startPage: 1, maxPage: 1, reloadHeaderPage: false, reloadDetail: false, loadImageFromWeb: false, loadImageToData: false, refreshImage: false, refreshDocumentStore: false);
...
TraceMongoCommand.Export("htc", "Handeco_Detail", Path.Combine(AppData.DataDirectory, @"mongo\export\export_Handeco_Detail.txt"), sort: "{ _id: 1 }");
pb.Data.Mongo.TraceMongoCommand.Count("htc", "Handeco_Detail");
...
RunSource.CurrentRunSource.GetProjectVariableValue(@"$Root$\Source\Lib\pb\Source\pb\IO\Test\Test_SharpCompressManager.project.xml").zTrace();
@"$Root$\Source\Lib\pb\Source\pb\IO\Test\Test_SharpCompressManager.project.xml".zGetRunSourceProjectVariableValue().zTrace();
@"$Root$\Source\Lib\pb\Source\pb\IO\Test\Test_SharpCompressManager.project.xml".zGetRunSourceProjectVariableValue().zRootPath(RunSource.CurrentRunSource.ProjectDirectory).zTrace();
@"$Root$\Source\Lib\pb\Source\pb\IO\Test\Test_SharpCompressManager.project.xml".zGetRunSourceProjectPath().zTrace();
...
RunSourceCommand.SetProject(@"$Root$\Lib\pb\Source\Project\_Test\Test_01.project.xml");

zReflection.GetType("runsourced.RunSourceFormExe").zGetTypeName().zTrace();
zReflection.GetType("pb.Compiler.RunSource").zGetTypeName().zTrace();
zReflection.GetType("pb.Trace").zGetTypeName().zTrace();
zReflection.GetMethod(zReflection.GetType("pb.Trace"), "WriteLine").zTrace();
...
Trace.WriteLine("toto");
RunSourceCommand.SetProjectFromSource();
RunSourceCommand.SetProject(@"$Root$\Lib\pb\Source\pb\_Test\Test_01.project.xml");

Test_CSharp.Test_Action_01();
...
"toto".zTrace();
new string[] { "toto", "tata", "tutu", "titi" }.zTrace();
new string[] { "toto", "tata", "tutu", "titi" }.zView();
//new string[] { "toto", "tata", "tutu", "titi" }.zView_v2();
//new string[] { "toto", "tata", "tutu", "titi" }.zView_v3();

XDocument.Load(@"c:\pib\drive\google\dev\project\.net\Apps\Damien\test_01.xml").zXPathElements("//toto").zView();
XDocument.Load(@"c:\pib\drive\google\dev\project\.net\Apps\Damien\test_01.xml").zXPathElements("xml/toto").zView();
XDocument.Load(@"c:\pib\drive\google\dev\project\.net\Apps\Damien\test_02.xml").zXPathElements("//ItemGroup").zView();
XDocument.Load(@"c:\pib\drive\google\dev\project\.net\Apps\Damien\hts_test_04.csproj").zXPathElements("//ItemGroup").zView();
XDocument.Load(@"c:\pib\drive\google\dev\project\.net\Apps\Damien\hts_test_04.csproj").zXPathElements("//PropertyGroup").zView();
XDocument.Load(@"c:\pib\drive\google\dev\project\.net\Apps\Damien\hts_test_04.csproj").zXPathElements("//*[local-name()='ItemGroup']").zView();
XDocument.Load(@"c:\pib\drive\google\dev\project\.net\Apps\Damien\hts_test_04.csproj").zXPathElements("/*[local-name()='ItemGroup']").zView();
//configuration/*[namespace-uri()='lcmp' and local-name()='MyNode']

RunSourceCommand.SetProjectFromSource();
RunSourceCommand.SetProject(@"$Root$\Lib\pb\Source\pb\Data\Xml\_Test\Test_Xml.project.xml");
Test_Xpath.Test_01();

XDocument xd = XDocument.Load(@"c:\pib\drive\google\dev\project\.net\Apps\Damien\hts_test_04.csproj");
XNamespace ns = xd.Root.GetDefaultNamespace();
//xd.Root.Elements(ns + "ItemGroup").zView();
xd.Root.Elements(ns + "ItemGroup").SelectMany(xe => xe.Elements(ns + "Compile")).zView();

HttpRun.LoadText("https://www.google.fr/");

HttpRun.LoadText(new HttpRequest { Url = "http://www.unea.fr/union-nationale-entreprises-adaptees/annuaire-unea/71/71/annuaire/annuaire.asp", Method = HttpRequestMethod.Post, Referer = "http://www.unea.fr/union-nationale-entreprises-adaptees/annuaire-unea/71/71/annuaire/annuaire.asp?txtRecherche=Entrez%20le%20nom%20d'une%20entreprise&hiddenValider=true", Content = "hiddenValider=true&txtRecherche=&txtRecherche1=&txtRecherche2=1&txtRecherche3=&txtRecherche4=" });
HttpRun.LoadText(new HttpRequest { Url = "http://unea.fr/union-nationale-entreprises-adaptees/annuaire-unea/71/71/annuaire/annuaire.asp", Method = HttpRequestMethod.Post, Referer = "http://unea.fr/union-nationale-entreprises-adaptees/annuaire-unea/71/71/annuaire/annuaire.asp?txtRecherche=&hiddenValider=true", Content = "hiddenValider=true&txtRecherche=&txtRecherche1=&txtRecherche6=&txtRecherche5=&txtRecherche2=1&txtRecherche3=&txtRecherche4=" });
HttpRun.LoadText("http://unea.fr/union-nationale-entreprises-adaptees/annuaire-unea/71/71/annuaire-unea.htm");
HttpRun.LoadText("http://unea.fr/union-nationale-entreprises-adaptees/annuaire-unea/71/71/annuaire/detail.asp?id=4011");


Uri uri = new Uri("http://unea.fr/union-nationale-entreprises-adaptees/annuaire-unea/71/71/annuaire/detail.asp?id=4011");
...
RunSourceCommand.CompileProject(@"$Root$\Apps\pbc\pbc.project.xml");
RunSourceCommand.CompileProjects(@"$Root$\Apps\pbc\pbc.projects.xml");

string s = "toto\x20tata";
string s = "toto\x00tata";
s = s.Replace('\x00', '@');
s.zTrace();

zfile.WriteFile(@"c:\pib\drive\google\dev_data\exe\runsource\test_unit\Web\HtmlToXml\test\test_04.html", "<p>toto\ntata</p>");


Trace.WriteLine("toto");
RunSourceCommand.SetProjectFromSource();
RunSourceCommand.SetProject(@"$Root$\Lib\pb\Source\pb\Web\Html\TestUnit\TestUnit.HtmlToXml.project.xml");

TestUnit_HtmlToXml.FileHtmlToXml_v2(@"c:\pib\drive\google\dev_data\exe\runsource\test_unit\Web\HtmlToXml\test\test_04.html");

HttpRun.LoadText(@"c:\pib\dev_data\exe\runsource\damien\hts\sites\unea.fr\cache\detail\4000\union-nationale-entreprises-adaptees_annuaire-unea_71_4011_adapei_du_bas-rhin_asea.htm");
HtmlRun.Select("//div[@class='ctn_content-article']");
HtmlRun.Select("//div[@class='ctn_content-article']//table//*[text() = 'NOS ACTIVITES']/following::div/ul");
foreach (XXElement xe2 in HttpRun.GetXDocument().zXXElement().XPathElements("//div[@class='ctn_content-article']//table//*[text() = 'NOS ACTIVITES']/following::div/ul/*"))
{
  if (xe2.XElement.Name == "li")
  {
    Trace.WriteLine($"li \"{xe2.XElement.Value}\"");
  }
  else if (xe2.XElement.Name == "ul")
  {
    ...
    foreach (XXElement xe3 in xe2.XPathElements("*"))
    {
      ...
      {
        Trace.WriteLine($"  li \"{xe3.XElement.Value}\"");
      }
      else if (xe3.XElement.Name == "ul")
      {
        Trace.WriteLine("  ul");
        Trace.WriteLine($"    li \"{xe3.XPathValue("li//text()")}\"");
      }
    }
  }
  else
    Trace.WriteLine(xe2.XElement.Name.LocalName);
}
