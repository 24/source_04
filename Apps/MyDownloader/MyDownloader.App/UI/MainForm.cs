...
namespace MyDownloader.App.UI
{
    public partial class MainForm : Form, ISingleInstanceEnforcer
    {
        ...
        //public DownloadList DownloadList { get { return downloadList1; } }
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            //downloadList1.Log(null, string.Format("DefaultDownloadDirectorySource \"{0}\"", DownloadManager.Instance.DefaultDownloadDirectorySource), MyDownloader.App.UI.DownloadList.LogMode.Information);
            //downloadList1.Log(null, string.Format("DefaultDownloadDirectory \"{0}\"", DownloadManager.Instance.DefaultDownloadDirectory), MyDownloader.App.UI.DownloadList.LogMode.Information);
            Log.Write(string.Format("DefaultDownloadDirectory \"{0}\"", DownloadManager.Instance.DefaultDownloadDirectory), LogMode.Information);
        }
        ...
        private void toolService_Click(object sender, EventArgs e)
        {
            StartStopWCFService();
        }
