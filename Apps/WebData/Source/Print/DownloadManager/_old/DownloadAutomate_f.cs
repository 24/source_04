...
namespace Download.Print.old
{
    ...
    {
        public static void BackupSite(ServerManager_v1 serverManager)
        {
            ...
            bool useTestManager = false, int? traceLevel = null)
        {
            ...
            DownloadAutomateManager_v1 downloadAutomate = CreateDownloadAutomate(version: version, useNewDownloadManager: useNewDownloadManager, useTestManager: useTestManager, traceLevel: traceLevel);
            try
            {
        ...
        public static void Test_TryDownload_02<TKey, TData>(WebDataManager_v1<TKey, TData> webDataManager, string query, string downloadDirectory = null, bool uncompressFile = true, bool forceDownloadAgain = false,
            bool forceSelect = false, bool simulateDownload = false, bool useNewDownloadManager = false, int version = 3, bool useTestManager = false)
        {
            ...
            DownloadAutomateManager_v1 downloadAutomate = CreateDownloadAutomate(version: version, useNewDownloadManager: useNewDownloadManager, useTestManager: useTestManager);
        ...
        public static DownloadManager_v1<DownloadPostKey_v1> CreateDownloadManager_v1(bool useTestManager = false)
        {
            XmlConfig config = XmlConfig.CurrentConfig;
            ...
            MongoCollectionManager_v1<DownloadPostKey_v1, DownloadedFile_v1<DownloadPostKey_v1>> mongoDownloadManager =
                new MongoCollectionManager_v1<DownloadPostKey_v1, DownloadedFile_v1<DownloadPostKey_v1>>(config.GetElement("DownloadAutomateManager/MongoDownloadFile"));
            ...
            MongoCollectionManager_v1<DownloadPostKey_v1, DownloadFile_v1<DownloadPostKey_v1>> mongoQueueDownloadManager =
                new MongoCollectionManager_v1<DownloadPostKey_v1, DownloadFile_v1<DownloadPostKey_v1>>(config.GetElement("DownloadAutomateManager/MongoQueueDownloadFile"));
            ...
            return new DownloadManager_v1<DownloadPostKey_v1>(downloadManagerClient, mongoDownloadManager, mongoQueueDownloadManager, debrider, CreateUncompressManager());
        }

        public static DownloadManager_v2<DownloadPostKey_v1> CreateDownloadManager(bool useTestManager = false)
        {
            XmlConfig config = XmlConfig.CurrentConfig;
            ...
            MongoCollectionManager_v1<DownloadPostKey_v1, DownloadedFile_v2<DownloadPostKey_v1>> mongoDownloadedFileManager =
                new MongoCollectionManager_v1<DownloadPostKey_v1, DownloadedFile_v2<DownloadPostKey_v1>>(config.GetElement("DownloadAutomateManager/MongoDownloadedFile"));
            ...
            MongoCollectionManager_v1<DownloadPostKey_v1, QueueDownloadFile_v2<DownloadPostKey_v1>> mongoQueueDownloadFileManager =
                new MongoCollectionManager_v1<DownloadPostKey_v1, QueueDownloadFile_v2<DownloadPostKey_v1>>(config.GetElement("DownloadAutomateManager/MongoQueueDownloadFile_new"));
            ...
            MongoCollectionManager_v1<DownloadPostKey_v1, DownloadLinkRef_v2> mongoCurrentDownloadFileManager =
                new MongoCollectionManager_v1<DownloadPostKey_v1, DownloadLinkRef_v2>(config.GetElement("DownloadAutomateManager/MongoCurrentDownloadFile"));
            ...
            DownloadManager_v2<DownloadPostKey_v1> downloadManager = new DownloadManager_v2<DownloadPostKey_v1>();
        ...
        public static DownloadManager CreateDownloadManager_v2(bool useTestManager = false)
        {
            XmlConfig config = XmlConfig.CurrentConfig;

            MongoCollectionManager<DownloadedFile> mongoDownloadedFileManager = MongoCollectionManager<DownloadedFile>.Create(config.GetElement("DownloadAutomateManager/MongoDownloadedFile"));
            mongoDownloadedFileManager.KeyName = "Key";     // Key is the name of key field in DownloadedFile_v2
            //mongoDownloadedFileManager.QueryKey = key => new QueryDocument { { "downloadedFile.Key.server", key.server }, { "downloadedFile.Key._id", BsonValue.Create(key.id) } };

            MongoCollectionManager<QueueDownloadFile> mongoQueueDownloadFileManager = MongoCollectionManager<QueueDownloadFile>.Create(config.GetElement("DownloadAutomateManager/MongoQueueDownloadFile_new"));
            mongoDownloadedFileManager.KeyName = "Key";     // Key is the name of key field in QueueDownloadFile_v2
            //mongoQueueDownloadFileManager.QueryKey = key => new QueryDocument { { "queueDownloadFile.Key.server", key.server }, { "queueDownloadFile.Key._id", BsonValue.Create(key.id) } };

            MongoCollectionManager<DownloadLinkRef> mongoCurrentDownloadFileManager = MongoCollectionManager<DownloadLinkRef>.Create(config.GetElement("DownloadAutomateManager/MongoCurrentDownloadFile"));
        ...
        public static FindPrintManager CreateFindPrintManager(int version = 3, bool dailyPrintManager = false, int gapDayBefore = 0, int gapDayAfter = 0)
        {
            ...
            if (dailyPrintManager)
            {
                ...
                findPrintManager.SetGapDayBefore(gapDayBefore);
                findPrintManager.SetGapDayAfter(gapDayAfter);
            }
        ...
        public static DownloadAutomateManager_v1 CreateDownloadAutomate(int version = 3, bool useNewDownloadManager = false, bool useTestManager = false, int? traceLevel = null)
        {
            ...
            DownloadManager_v1<DownloadPostKey_v1> downloadManager_v1 = null;
            if (!useNewDownloadManager)
                downloadManager_v1 = CreateDownloadManager_v1(useTestManager);

            DownloadManager_v2<DownloadPostKey_v1> downloadManager = null;
            if (useNewDownloadManager)
            ...
            DownloadAutomateManager_v1 downloadAutomate = new DownloadAutomateManager_v1();
            ...
            downloadAutomate.DownloadAllPrintType = printType => printType == PrintType.Print;
            ...
            {
                ServerManager_v1 serverManager = ServerManagers_v1.Get(xe.zExplicitAttribValue("name"));
        ...
        //public static void InitServers_v2(bool test = false)
        //{
        //    Vosbooks.Vosbooks_v2.Init(test);
        //}

        //public static DownloadAutomateManager_v2 CreateDownloadAutomate_v2(int version = 3, bool useTestManager = false, int? traceLevel = null, bool test = false)
        //{
        //    // le 01/11/2014 désactive version 1 et version 2
        //    // version 1 : utilise l'ancien FindPrintManager, l'ancienne liste de print dans print_list1.xml, l'ancien pattern de date FindPrints/Dates/Date avec l'ancien FindDateManager
        //    // version 2 : version 1 + le nouveau FindPrintManager_new avec le nouveau PrintTitleManager, la nouvelle liste de print dans print_list2.xml,
        ...
        //    Trace.WriteLine("create download automate : version {0} useTestManager {1} traceLevel {2}", version, useTestManager, traceLevel.zToStringOrNull());

        //    XmlConfig config = XmlConfig.CurrentConfig;
        //    XElement xeAutomateConfig;
        //    if (!test)
        //        xeAutomateConfig = XmlConfig.CurrentConfig.GetElement("DownloadAutomateManager");
        //    else
        //        xeAutomateConfig = XmlConfig.CurrentConfig.GetElement("DownloadAutomateManager_Test");

        //    MongoDownloadAutomateManager mongoDownloadAutomateManager = GetMongoDownloadAutomateManager();

        //    DownloadManager_v2 downloadManager = CreateDownloadManager_v2(useTestManager);

        //    MailSender mailSender = new MailSender(config.GetConfig("LocalConfig").Get("DownloadAutomateManager/Gmail/Mail"), config.GetConfig("LocalConfig").Get("DownloadAutomateManager/Gmail/Password"),
        //        config.GetConfig("LocalConfig").Get("DownloadAutomateManager/Gmail/SmtpHost"), config.GetConfig("LocalConfig").Get("DownloadAutomateManager/Gmail/SmtpPort").zTryParseAs<int>(587));
        //    //MailMessage mailMessage = new MailMessage(config.GetConfig("LocalConfig").Get("DownloadAutomateManager/Gmail/Mail"), config.Get("DownloadAutomateManager/Mail/To"),
        //    //    config.Get("DownloadAutomateManager/Mail/Subject"), config.Get("DownloadAutomateManager/Mail/Body"));
        //    MailMessage mailMessage = new MailMessage(config.GetConfig("LocalConfig").Get("DownloadAutomateManager/Gmail/Mail"), xeAutomateConfig.zXPathValue("Mail/To"),
        //        xeAutomateConfig.zXPathValue("Mail/Subject"), xeAutomateConfig.zXPathValue("Mail/Body"));

        //    DownloadAutomateManager_v2 downloadAutomate = new DownloadAutomateManager_v2();
        ...
        //    //ExtremeDown.ExtremeDown.FakeInit();
        //    //foreach (XElement xe in config.GetElements("DownloadAutomateManager/ServerManagers/ServerManager"))
        //    foreach (XElement xe in xeAutomateConfig.zXPathElements("ServerManagers/ServerManager"))
        //    {
        //        ServerManager serverManager = ServerManagers_v2.Get(xe.zExplicitAttribValue("name"));
        //        serverManager.EnableLoadNewPost = xe.zAttribValue("enableLoadNewPost").zTryParseAs<bool>(true);
        //        serverManager.EnableSearchPostToDownload = xe.zAttribValue("enableSearchPostToDownload").zTryParseAs<bool>(true);
        //        serverManager.DownloadDirectory = xe.zAttribValue("downloadDirectory").zNullIfEmpty();
        //        downloadAutomate.AddServerManager(serverManager);
        ...
        //    //    Trace.WriteLine("mongo queue download manager collection           {0}", downloadAutomate.DownloadManager_v1.MongoQueueDownloadFileManager.GetCollection().zGetFullName());
        //    //}
        //    if (downloadAutomate.DownloadManager != null)
        //    {
        //        Trace.WriteLine("mongo download manager collection                 {0}", downloadAutomate.DownloadManager.MongoDownloadedFileManager.GetCollection().zGetFullName());
        //        Trace.WriteLine("mongo queue download manager collection           {0}", downloadAutomate.DownloadManager.MongoQueueDownloadFileManager.GetCollection().zGetFullName());
        //        Trace.WriteLine("mongo current download file manager collection    {0}", downloadAutomate.DownloadManager.MongoCurrentDownloadFileManager.GetCollection().zGetFullName());
        ...
        //    if (!ControlDownloadManagerClient_v2(downloadAutomate))
        //        throw new PBException("error DownloadManagerClient is not working");
        ...
        public static bool ControlDownloadManagerClient(DownloadAutomateManager_v1 downloadAutomate)
        {
        ...
        public static bool ControlDownloadManagerClient_v2(DownloadAutomateManager downloadAutomate)
        {
            Trace.Write("control download manager client");
            try
            {
