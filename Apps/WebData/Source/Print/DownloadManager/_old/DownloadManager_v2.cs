...
{
    public class QueueDownloadFile_v2<TKey>
    {
        // mongo id
        public int Id = 0;
        [BsonIgnore]
    ...
    public class DownloadedFile_v2<TKey>
    {
        // mongo id
        public int Id;
        public TKey Key;
    ...
    public class DownloadLinkRef_v2
    {
    ...
    public class DownloadManager_v2<TKey> : AsyncManager, IDisposable
    {
        ...
        private MongoCollectionManager_v1<TKey, DownloadedFile_v2<TKey>> _mongoDownloadedFileManager = null;
        private MongoCollectionManager_v1<TKey, QueueDownloadFile_v2<TKey>> _mongoQueueDownloadFileManager = null;
        private MongoCollectionManager_v1<TKey, DownloadLinkRef_v2> _mongoCurrentDownloadFileManager = null;
        private ConcurrentDictionary<int, QueueDownloadFile_v2<TKey>> _queueDownloadFiles = new ConcurrentDictionary<int, QueueDownloadFile_v2<TKey>>();
        private Dictionary<int, DownloadLinkRef_v2> _currentDownloadFiles = new Dictionary<int, DownloadLinkRef_v2>();
        private ProtectLink __protectLink = null;
        private Debrider _debrider = null;
        private UncompressManager _uncompressManager = null;
        private Action<DownloadedFile_v2<TKey>> _onDownloaded = null;
        ...
        public MongoCollectionManager_v1<TKey, DownloadedFile_v2<TKey>> MongoDownloadedFileManager { get { return _mongoDownloadedFileManager; } set { _mongoDownloadedFileManager = value; } }
        public MongoCollectionManager_v1<TKey, QueueDownloadFile_v2<TKey>> MongoQueueDownloadFileManager { get { return _mongoQueueDownloadFileManager; } set { _mongoQueueDownloadFileManager = value; } }
        public MongoCollectionManager_v1<TKey, DownloadLinkRef_v2> MongoCurrentDownloadFileManager { get { return _mongoCurrentDownloadFileManager; } set { _mongoCurrentDownloadFileManager = value; } }
        ...
        public Action<DownloadedFile_v2<TKey>> OnDownloaded { get { return _onDownloaded; } set { _onDownloaded = value; } }
        ...
        public void AddFileToDownload(TKey key, IRequestDownloadLinks downloadLinks, string file)
        {
            ...
            QueueDownloadFile_v2<TKey> downloadFile = new QueueDownloadFile_v2<TKey> { Key = key, DownloadItemLinks = downloadItemLinks, RequestTime = DateTime.Now, File = file };
        ...
        protected override void ThreadExecute()
        {
            if (_trace)
            {
                ...
                foreach (QueueDownloadFile_v2<TKey> downloadFile in _queueDownloadFiles.Values)
                {
        ...
        private void ManageEndDownloadFiles()
        {
            ...
            {
                DownloadLinkRef_v2 downloadLinkRef = _currentDownloadFiles[key];
                ...
                {
                    QueueDownloadFile_v2<TKey> downloadFile = GetQueueDownloadFile(downloadLinkRef.QueueDownloadFileId);
                    downloadFile.Modified = true;
        ...
        private void EndDownload(QueueDownloadFile_v2<TKey> queueDownloadFile)
        {
            try
            {
                if (_trace)
                ...
                DownloadedFile_v2<TKey> downloadedFile = new DownloadedFile_v2<TKey>();
                ...
                QueueDownloadFile_v2<TKey> downloadFile2;
        ...
        private void ManageNewDownloadFiles()
        {
            ...
            foreach (QueueDownloadFile_v2<TKey> downloadFile in _mongoQueueDownloadFileManager.Find("{}", sort: "{ _id: 1 }"))
            {
                QueueDownloadFile_v2<TKey> downloadFile2 = downloadFile;
                ...
                while (true)
                {
                    ...
                    DownloadLinkRef_v2 downloadLinkRef = GetNextDownloadLink(downloadFile2);
        ...
        private DownloadLinkRef_v2 GetNextDownloadLink(QueueDownloadFile_v2<TKey> downloadFile)
        {
                        ...
                        else
                        {
                            ...
                            for (int filePartIndex = 0; filePartIndex < serverLink.FilePartLinks.Length; filePartIndex++)
                            {
                                ...
                                if (UnprotectLink(downloadFile, serverLink, filePartLink, filePartIndex))
                                {
                                    ...
                                    if (DebridLink(downloadFile, itemLink, serverLink, filePartLink, out debridedLink, out file))
                                    {
                                        return new DownloadLinkRef_v2 { QueueDownloadFileId = downloadFile.Id, ItemIndex = itemIndex, ServerIndex = itemLink.SelectedServerIndex, FilePartIndex = filePartIndex, DebridedDownloadLink = debridedLink, File = file };
                                    }
                                    else
                                    {
                                        //downloadFile.UncompleteDownload = true;
        ...
        private bool UnprotectLink(QueueDownloadFile_v2<TKey> downloadFile, DownloadServerLink serverLink, DownloadFilePartLink filePartLink, int filePartLinkIndex)
        {
        ...
        private bool DebridLink(QueueDownloadFile_v2<TKey> downloadFile, DownloadItemLink itemLink, DownloadServerLink serverLink, DownloadFilePartLink filePartLink,
        ...
        {
            DownloadedFile_v2<TKey> downloadedFile = GetDownloadedFile(key);
            if (downloadedFile != null)
                return downloadedFile.State;
            QueueDownloadFile_v2<TKey> queueDownloadFile = GetQueueDownloadFile(key);
        ...
        public QueueDownloadFile_v2<TKey> GetQueueDownloadFile(TKey key)
        {
            return _mongoQueueDownloadFileManager.Load(key);
        }

        private QueueDownloadFile_v2<TKey> GetQueueDownloadFile(int id)
        {
            QueueDownloadFile_v2<TKey> downloadFile = null;
        ...
        public DownloadedFile_v2<TKey> GetDownloadedFile(TKey key)
        {
            return _mongoDownloadedFileManager.Load(key);
        }

        private DownloadItemLink GetDownloadItemLink(DownloadLinkRef_v2 downloadLinkRef)
        {
        ...
        private DownloadFilePartLink GetDownloadFilePartLink(DownloadLinkRef_v2 downloadLinkRef)
        {
            //QueueDownloadFile<TKey> downloadFile = GetQueueDownloadFile(downloadLinkRef);
            QueueDownloadFile_v2<TKey> downloadFile = GetQueueDownloadFile(downloadLinkRef.QueueDownloadFileId);
            if (downloadFile != null)
        ...
        private bool ContainsCompressFiles(QueueDownloadFile_v2<TKey> downloadFile)
        {
            foreach (DownloadItemLink itemLink in downloadFile.DownloadItemLinks)
            {
                if (itemLink.SelectedServerIndex != -1)
        ...
        private void SaveQueueDownloadFile(QueueDownloadFile_v2<TKey> downloadFile)
        {
