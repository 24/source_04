...
namespace Download.Print.Ebookdz
{
    ...
    public class Ebookdz_PostDetail : IPost, IKeyData<int>, IWebData
    {
    ...
    public static class Ebookdz_DetailManager
    {
        ...
        public static WebHeaderDetailManager<int, Ebookdz_HeaderPage, Ebookdz_PostHeader, int, Ebookdz_PostDetail> WebForumHeaderDetailManager { get { return __webForumHeaderDetailManager; } }

        public static LoadNewDocumentsResult LoadForumNewDocuments(bool reloadForums = false, int maxNbDocumentsLoadedFromStore = 5, int maxPage = 20, bool loadImage = true, Predicate<Ebookdz_Forum> filter = null)
        {
            LoadNewDocumentsResult result = new LoadNewDocumentsResult();
            foreach (Ebookdz_Forum forum in Ebookdz_MainForumManager.CurrentMainForumManager.LoadSubForums(reload: reloadForums, filter: filter))
            {
        ...
        private static WebDataManager<int, Ebookdz_PostDetail> CreateWebDataManager(XElement xe)
        {
            ...
            detailWebDataManager.WebLoadDataManager.GetHttpRequestParameters = EbookdzLogin.GetHttpRequestParameters;
        ...
        private static Ebookdz_PostDetail GetData(WebResult webResult)
        {
