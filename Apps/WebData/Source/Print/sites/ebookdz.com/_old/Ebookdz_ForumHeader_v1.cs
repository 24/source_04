...
{
    public class Ebookdz_ForumHeaderManager_v1 : WebDataPageManager_v1<int, Ebookdz_HeaderPage_v1, Ebookdz_PostHeader>
    {
        private static Ebookdz_ForumHeaderManager_v1 __currentForumHeaderManager = null;

        static Ebookdz_ForumHeaderManager_v1()
        {
            __currentForumHeaderManager = CreateForumHeaderManager(XmlConfig.CurrentConfig.GetElement("Ebookdz/ForumHeader"));
        }

        public static Ebookdz_ForumHeaderManager_v1 CurrentForumHeaderManager { get { return __currentForumHeaderManager; } }

        private static Ebookdz_ForumHeaderManager_v1 CreateForumHeaderManager(XElement xe)
        {
            ...
            Ebookdz_ForumHeaderManager_v1 forumHeaderManager = new Ebookdz_ForumHeaderManager_v1();

            forumHeaderManager.WebLoadDataManager = new WebLoadDataManager<Ebookdz_HeaderPage_v1>();
            ...
            forumHeaderManager.WebLoadDataManager.InitLoadFromWeb = EbookdzLogin_v1.InitLoadFromWeb;
            forumHeaderManager.WebLoadDataManager.GetHttpRequestParameters = EbookdzLogin_v1.GetHttpRequestParameters;
            ...
            {
                MongoDocumentStore_v4<int, Ebookdz_HeaderPage_v1> documentStore = new MongoDocumentStore_v4<int, Ebookdz_HeaderPage_v1>(xe.zXPathValue("MongoServer"), xe.zXPathValue("MongoDatabase"), xe.zXPathValue("MongoCollection"), xe.zXPathValue("MongoDocumentItemName"));
