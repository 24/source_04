...
{
    public class ExtremeDown_PostDetail : IPost, IKeyData<int>, IWebData
    {
    ...
    public static class ExtremeDown_DetailManager
    {
        private static bool __trace = false;
        private static WebDataManager<int, ExtremeDown_PostDetail> __detailWebDataManager = null;
        private static WebHeaderDetailManager<int, ExtremeDown_HeaderPage, ExtremeDown_PostHeader, int, ExtremeDown_PostDetail> __webHeaderDetailManager = null;
        private static bool __getLinksExtremeProtect = true;
        private static ExtremeProtect __extremeProtect = new ExtremeProtect();

        static ExtremeDown_DetailManager()
        {
            __detailWebDataManager = CreateWebDataManager(XmlConfig.CurrentConfig.GetElement("ExtremeDown/Detail"));

            __webHeaderDetailManager = new WebHeaderDetailManager<int, ExtremeDown_HeaderPage, ExtremeDown_PostHeader, int, ExtremeDown_PostDetail>();
            __webHeaderDetailManager.HeaderDataPageManager = ExtremeDown_HeaderManager.HeaderWebDataPageManager;
            __webHeaderDetailManager.DetailDataManager = __detailWebDataManager;
        }

        public static bool Trace { get { return __trace; } set { __trace = value; } }
        public static WebDataManager<int, ExtremeDown_PostDetail> DetailWebDataManager { get { return __detailWebDataManager; } }
        public static WebHeaderDetailManager<int, ExtremeDown_HeaderPage, ExtremeDown_PostHeader, int, ExtremeDown_PostDetail> WebHeaderDetailManager { get { return __webHeaderDetailManager; } }

        private static WebDataManager<int, ExtremeDown_PostDetail> CreateWebDataManager(XElement xe)
        {
            WebDataManager<int, ExtremeDown_PostDetail> detailWebDataManager = new WebDataManager<int, ExtremeDown_PostDetail>();

            detailWebDataManager.WebLoadDataManager = new WebLoadDataManager<ExtremeDown_PostDetail>();
            ...
            detailWebDataManager.WebLoadDataManager.GetHttpRequestParameters = ExtremeDown.GetHttpRequestParameters;
            ...
            detailWebDataManager.DocumentStore = MongoDocumentStore<int, ExtremeDown_PostDetail>.Create(xe);

            return detailWebDataManager;
        }

        private static ExtremeDown_PostDetail GetData(WebResult webResult)
        {
