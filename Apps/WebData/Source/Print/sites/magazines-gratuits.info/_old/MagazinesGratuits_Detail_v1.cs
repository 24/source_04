...
{
    public class MagazinesGratuits_PostDetail_v1 : IPost, IKeyData<string>, IWebData
    {
    ...
    public static class MagazinesGratuits_DetailManager_v1
    {
        private static bool __trace = false;
        private static WebDataManager<string, MagazinesGratuits_PostDetail_v1> __detailWebDataManager = null;
        private static WebHeaderDetailManager<int, MagazinesGratuits_HeaderPage, MagazinesGratuits_PostHeader, string, MagazinesGratuits_PostDetail_v1> __webHeaderDetailManager = null;
        ...
        public static WebDataManager<string, MagazinesGratuits_PostDetail_v1> DetailWebDataManager { get { return __detailWebDataManager; } }
        public static WebHeaderDetailManager<int, MagazinesGratuits_HeaderPage, MagazinesGratuits_PostHeader, string, MagazinesGratuits_PostDetail_v1> WebHeaderDetailManager { get { return __webHeaderDetailManager; } }

        private static WebDataManager<string, MagazinesGratuits_PostDetail_v1> CreateWebDataManager(XElement xe)
        {
            WebDataManager<string, MagazinesGratuits_PostDetail_v1> detailWebDataManager = new WebDataManager<string, MagazinesGratuits_PostDetail_v1>();

            detailWebDataManager.WebLoadDataManager = new WebLoadDataManager<MagazinesGratuits_PostDetail_v1>();
            ...
            detailWebDataManager.WebLoadDataManager.GetHttpRequestParameters = MagazinesGratuits.GetHttpRequestParameters;
            ...
            detailWebDataManager.DocumentStore = MongoDocumentStore<string, MagazinesGratuits_PostDetail_v1>.Create(xe);

            return detailWebDataManager;
        }

        private static MagazinesGratuits_PostDetail_v1 GetData(WebResult webResult)
        {
            ...
            MagazinesGratuits_PostDetail_v1 data = new MagazinesGratuits_PostDetail_v1();
        ...
        {
            string key = GetPostDetailKey(httpRequest);
        ...
        private static string GetPostDetailKey(HttpRequest httpRequest)
        {
            // http://www.magazines-gratuits.org/le-monde-et-supplement-du-dimanche-13-et-lundi-14-decembre-2015.html
            // http://www.magazines-gratuits.org/les-journaux-du-samedi-12-decembre-2015.html
