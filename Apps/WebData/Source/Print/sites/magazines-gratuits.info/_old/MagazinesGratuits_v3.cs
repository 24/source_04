...
namespace Download.Print.MagazinesGratuits.old
{
    public class MagazinesGratuits_v3 : PostHeaderDetailMongoManagerBase_v1<MagazinesGratuits_PostDetail>
    {
        ...
        public static void Init(bool test = false)
        {
            ...
            __current = new MagazinesGratuits_v3();
            __current.HeaderPageNominalType = typeof(PostHeaderDataPage_v1);
        ...
        public static MagazinesGratuits_v3 Current { get { return __current; } }
