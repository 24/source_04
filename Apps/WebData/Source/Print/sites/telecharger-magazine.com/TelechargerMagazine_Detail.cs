...
{
    public class TelechargerMagazine_PostDetail : IPost, IKeyData<int>, IWebData
    {
        ...
        {
            return TelechargerMagazine.GetServer();
        }
    ...
    public static class TelechargerMagazine_DetailManager
    {
        ...
        static TelechargerMagazine_DetailManager()
        {
            __detailWebDataManager = CreateWebDataManager(XmlConfig.CurrentConfig.GetElement("TelechargerMagazine/Detail"));

            __webHeaderDetailManager = new WebHeaderDetailManager<int, TelechargerMagazine_HeaderPage, TelechargerMagazine_PostHeader, int, TelechargerMagazine_PostDetail>();
            __webHeaderDetailManager.HeaderDataPageManager = TelechargerMagazine_HeaderManager.HeaderWebDataPageManager;
        ...
        {
            WebDataManager<int, TelechargerMagazine_PostDetail> detailWebDataManager = new WebDataManager<int, TelechargerMagazine_PostDetail>();

            detailWebDataManager.WebLoadDataManager = new WebLoadDataManager<TelechargerMagazine_PostDetail>();
            ...
            detailWebDataManager.WebLoadDataManager.GetHttpRequestParameters = TelechargerMagazine.GetHttpRequestParameters;
