...
{
    public class Vosbooks_PostDetail : IPost, IKeyData<int>, IWebData
    {
    ...
    public static class Vosbooks_DetailManager
    {
        private static bool __trace = false;
        private static WebDataManager<int, Vosbooks_PostDetail> __detailWebDataManager = null;
        private static WebHeaderDetailManager<int, Vosbooks_HeaderPage, Vosbooks_PostHeader, int, Vosbooks_PostDetail> __webHeaderDetailManager = null;
        private static Date? __lastPostDate = null;

        static Vosbooks_DetailManager()
        {
            __detailWebDataManager = CreateWebDataManager(XmlConfig.CurrentConfig.GetElement("Vosbooks/Detail"));

            __webHeaderDetailManager = new WebHeaderDetailManager<int, Vosbooks_HeaderPage, Vosbooks_PostHeader, int, Vosbooks_PostDetail>();
            __webHeaderDetailManager.HeaderDataPageManager = Vosbooks_HeaderManager.HeaderWebDataPageManager;
            __webHeaderDetailManager.DetailDataManager = __detailWebDataManager;
        }

        public static bool Trace { get { return __trace; } set { __trace = value; } }
        public static WebDataManager<int, Vosbooks_PostDetail> DetailWebDataManager { get { return __detailWebDataManager; } }
        public static WebHeaderDetailManager<int, Vosbooks_HeaderPage, Vosbooks_PostHeader, int, Vosbooks_PostDetail> WebHeaderDetailManager { get { return __webHeaderDetailManager; } }

        private static WebDataManager<int, Vosbooks_PostDetail> CreateWebDataManager(XElement xe)
        {
            WebDataManager<int, Vosbooks_PostDetail> detailWebDataManager = new WebDataManager<int, Vosbooks_PostDetail>();

            detailWebDataManager.WebLoadDataManager = new WebLoadDataManager<Vosbooks_PostDetail>();
            ...
            detailWebDataManager.WebLoadDataManager.GetHttpRequestParameters = Vosbooks.GetHttpRequestParameters;
        ...
        private static Vosbooks_PostDetail GetData(WebResult webResult)
        {
