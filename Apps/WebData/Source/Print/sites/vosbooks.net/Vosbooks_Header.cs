...
{
    public class Vosbooks_PostHeader : IHeaderData
    {
    ...
    public class Vosbooks_HeaderPage : IEnumDataPages<Vosbooks_PostHeader>
    {
        public int Id;
        public string SourceUrl;
        public DateTime LoadFromWebDate;

        public Vosbooks_PostHeader[] PostHeaders;
        public string UrlNextPage;

        public IEnumerable<Vosbooks_PostHeader> GetDataList()
        {
            return PostHeaders;
        }
    ...
    public static class Vosbooks_HeaderManager
    {
        private static string __urlMainPage = "http://www.vosbooks.net/";
        private static WebDataPageManager<int, Vosbooks_HeaderPage, Vosbooks_PostHeader> __headerWebDataPageManager = null;

        static Vosbooks_HeaderManager()
        {
            __headerWebDataPageManager = CreateWebDataPageManager(XmlConfig.CurrentConfig.GetElement("Vosbooks/Header"));
        }

        public static WebDataPageManager<int, Vosbooks_HeaderPage, Vosbooks_PostHeader> HeaderWebDataPageManager { get { return __headerWebDataPageManager; } }

        private static WebDataPageManager<int, Vosbooks_HeaderPage, Vosbooks_PostHeader> CreateWebDataPageManager(XElement xe)
        {
            WebDataPageManager<int, Vosbooks_HeaderPage, Vosbooks_PostHeader> headerWebDataPageManager = new WebDataPageManager<int, Vosbooks_HeaderPage, Vosbooks_PostHeader>();
            ...
            headerWebDataPageManager.WebLoadDataManager.GetHttpRequestParameters = Vosbooks.GetHttpRequestParameters;
            ...
            headerWebDataPageManager.DocumentStore = MongoDocumentStore<int, Vosbooks_HeaderPage>.Create(xe);
        ...
        private static Vosbooks_HeaderPage GetData(WebResult webResult)
        {
            ...
            Vosbooks_HeaderPage data = new Vosbooks_HeaderPage();
            data.SourceUrl = url;
