...
namespace Download.Print.Vosbooks.old
{
    ...
    public class Vosbooks_PostDetail_v2 : IPostToDownload // : IPost, IKeyData<int>, IWebData
    {
    ...
    public static class Vosbooks_DetailManager_v2
    {
        private static bool __trace = false;
        private static WebDataManager<Vosbooks_PostDetail_v2> __detailWebDataManager = null;
        private static WebHeaderDetailManager_v2<Vosbooks_PostDetail_v2> __webHeaderDetailManager = null;
        private static Date? __lastPostDate = null;

        static Vosbooks_DetailManager_v2()
        {
            //Init();
        ...
        public static WebDataManager<Vosbooks_PostDetail_v2> DetailWebDataManager { get { return __detailWebDataManager; } }
        public static WebHeaderDetailManager_v2<Vosbooks_PostDetail_v2> WebHeaderDetailManager { get { return __webHeaderDetailManager; } }

        private static WebDataManager<Vosbooks_PostDetail_v2> CreateWebDataManager(XElement xe)
        {
            WebDataManager<Vosbooks_PostDetail_v2> detailWebDataManager = new WebDataManager<Vosbooks_PostDetail_v2>();

            detailWebDataManager.WebLoadDataManager = new WebLoadDataManager<Vosbooks_PostDetail_v2>();
            ...
            detailWebDataManager.WebLoadDataManager.GetHttpRequestParameters = Vosbooks_v2.GetHttpRequestParameters;
            ...
            detailWebDataManager.DocumentStore = MongoDocumentStore<Vosbooks_PostDetail_v2>.Create(xe);

            return detailWebDataManager;
        }

        private static Vosbooks_PostDetail_v2 GetData(WebResult webResult)
        {
            ...
            Vosbooks_PostDetail_v2 data = new Vosbooks_PostDetail_v2();
