...
{
    public class Vosbooks_v4 : PostHeaderDetailMongoManagerBase_v1<Vosbooks_PostDetail>
    {
        private static bool __trace = false;
        private static string __serverName = "vosbooks.net";
        private static string __configName = "Vosbooks";
        private static Vosbooks_v4 __current = null;
        ...
        public static Vosbooks_v4 Current { get { return __current; } }
        ...
        {
            //return _detailWebDataManager.Find(string.Format("{{ _id: {0} }}", id)).FirstOrDefault();
