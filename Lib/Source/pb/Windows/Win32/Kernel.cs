...
{
    #region class Kernel_struct
    public abstract class Kernel_struct
    {
        #region struct OVERLAPPED
        ...
        #region struct PROCESS_INFORMATION
        ...
        #region struct ACCESS_ALLOWED_ACE
        ...
        #region struct ACCESS_DENIED_ACE
        ...
        #region struct SYSTEM_AUDIT_ACE
        ...
        #region struct SYSTEM_ALARM_ACE
        ...
        #region struct ACL_REVISION_INFORMATION
        ...
        #region struct ACL_SIZE_INFORMATION
        ...
        #region struct SECURITY_DESCRIPTOR
        ...
        #region struct EXCEPTION_RECORD
        ...
        #region struct EXCEPTION_DEBUG_INFO
        ...
        #region struct CREATE_THREAD_DEBUG_INFO
        ...
        #region struct CREATE_PROCESS_DEBUG_INFO
        ...
        #region struct EXIT_THREAD_DEBUG_INFO
        ...
        #region struct EXIT_PROCESS_DEBUG_INFO
        ...
        #region struct LOAD_DLL_DEBUG_INFO
        ...
        #region struct UNLOAD_DLL_DEBUG_INFO
        ...
        #region struct OUTPUT_DEBUG_STRING_INFO
        ...
        #region struct CRITICAL_SECTION
        ...
        #region struct BY_HANDLE_FILE_INFORMATION
        ...
        #region struct MEMORY_BASIC_INFORMATION
        ...
        #region struct TOKEN_PRIVILEGES
        ...
        #region struct EXCEPTION_POINTERS
        ...
        #region struct TIME_ZONE_INFORMATION
        public struct TIME_ZONE_INFORMATION
        {
            public int Bias;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
            public short[] StandardName;
            public User.Struct.SYSTEMTIME StandardDate;
            public int StandardBias;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
            public short[] DaylightName;
            public User.Struct.SYSTEMTIME DaylightDate;
            public int DaylightBias;
        }
        #endregion

        #region struct WIN32_STREAM_ID
        ...
        #region struct CPINFO
        public struct CPINFO
        {
            public int MaxCharSize;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = Kernel_const.MAX_DEFAULTCHAR)]
            public byte[] DefaultChar;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = Kernel_const.MAX_LEADBYTES)]
            public byte[] LeadByte;
        }
        #endregion

        #region struct NUMBERFMT
        ...
        #region struct KEY_EVENT_RECORD
        ...
        #region struct MOUSE_EVENT_RECORD
        ...
        #region struct WINDOW_BUFFER_SIZE_RECORD
        ...
        #region struct MENU_EVENT_RECORD
        ...
        #region struct FOCUS_EVENT_RECORD
        ...
        #region struct CONSOLE_SCREEN_BUFFER_INFO
        ...
        #region struct CONSOLE_CURSOR_INFO
        ...
        #region struct SID_IDENTIFIER_AUTHORITY
        ...
        #region struct SID_AND_ATTRIBUTES
        ...
        public struct WIN32_FIND_DATA
        {
            ...
            public int dwReserved1;
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = Kernel_const.MAX_PATH)]
        ...
        #region struct ENUM_SERVICE_STATUS
        ...
        #region struct QUERY_SERVICE_LOCK_STATUS
        ...
        #region struct QUERY_SERVICE_CONFIG
        ...
        #region struct SERVICE_TABLE_ENTRY
        ...
        public struct PERF_DATA_BLOCK
        {
            ...
            public User.Struct.SYSTEMTIME SystemTime;
        ...
        #region struct PERF_OBJECT_TYPE
        ...
        #region struct PERF_COUNTER_DEFINITION
        ...
        #region struct PERF_INSTANCE_DEFINITION
        ...
        #region struct PERF_COUNTER_BLOCK
        ...
        #region struct SYSTEM_POWER_STATUS
    ...
    #region class Kernel_const
    public abstract class Kernel_const
    {
    ...
    public abstract class AdvApi
    {
		...
		[DllImport("advapi32")] public static extern Kernel_struct.SID_IDENTIFIER_AUTHORITY GetSidIdentifierAuthority(IntPtr pSid);
		[DllImport("advapi32")] public static extern int AbortSystemShutdown(string lpMachineName);
		[DllImport("advapi32")] public static extern int AccessCheck(ref Kernel_struct.SECURITY_DESCRIPTOR pSecurityDescriptor, int ClientToken, int DesiredAccess, Kernel_struct.GENERIC_MAPPING GenericMapping, Kernel_struct.PRIVILEGE_SET PrivilegeSet, int PrivilegeSetLength, int GrantedAccess, int Status);
		[DllImport("advapi32")] public static extern int AccessCheckAndAuditAlarm(string SubsystemName, IntPtr HandleId, string ObjectTypeName, string ObjectName, Kernel_struct.SECURITY_DESCRIPTOR SecurityDescriptor, int DesiredAccess, Kernel_struct.GENERIC_MAPPING GenericMapping, int ObjectCreation, int GrantedAccess, int AccessStatus, ref int pfGenerateOnClose);
		[DllImport("advapi32")] public static extern int AddAccessAllowedAce(ref Kernel_struct.ACL pAcl, int dwAceRevision, int AccessMask, IntPtr pSid);
		[DllImport("advapi32")] public static extern int AddAccessDeniedAce(ref Kernel_struct.ACL pAcl, int dwAceRevision, int AccessMask, IntPtr pSid);
		[DllImport("advapi32")] public static extern int AddAce(ref Kernel_struct.ACL pAcl, int dwAceRevision, int dwStartingAceIndex, IntPtr pAceList, int nAceListLength);
		[DllImport("advapi32")] public static extern int AddAuditAccessAce(ref Kernel_struct.ACL pAcl, int dwAceRevision, int dwAccessMask, IntPtr pSid, int bAuditSuccess, int bAuditFailure);
		[DllImport("advapi32")] public static extern int AdjustTokenGroups(int TokenHandle, int ResetToDefault, Kernel_struct.TOKEN_GROUPS NewState, int BufferLength, Kernel_struct.TOKEN_GROUPS PreviousState, int ReturnLength);
		[DllImport("advapi32")] public static extern int AdjustTokenPrivileges(int TokenHandle, int DisableAllPrivileges, Kernel_struct.TOKEN_PRIVILEGES NewState, int BufferLength, Kernel_struct.TOKEN_PRIVILEGES PreviousState, int ReturnLength);
		[DllImport("advapi32")] public static extern int AllocateAndInitializeSid(ref Kernel_struct.SID_IDENTIFIER_AUTHORITY pIdentifierAuthority, Byte nSubAuthorityCount, int nSubAuthority0, int nSubAuthority1, int nSubAuthority2, int nSubAuthority3, int nSubAuthority4, int nSubAuthority5, int nSubAuthority6, int nSubAuthority7, ref int lpPSid);
		[DllImport("advapi32")] public static extern int AllocateLocallyUniqueId(Kernel_struct.LARGE_INTEGER Luid);
		...
		[DllImport("advapi32")] public static extern int ControlService(HANDLE hService, int dwControl, ref Kernel_struct.SERVICE_STATUS lpServiceStatus);
		[DllImport("advapi32")] public static extern int CopySid(int nDestinationSidLength, IntPtr pDestinationSid, IntPtr pSourceSid);
		[DllImport("advapi32")] public static extern int CreatePrivateObjectSecurity(ref Kernel_struct.SECURITY_DESCRIPTOR ParentDescriptor, Kernel_struct.SECURITY_DESCRIPTOR CreatorDescriptor, Kernel_struct.SECURITY_DESCRIPTOR NewDescriptor, int IsDirectoryObject, int Token, Kernel_struct.GENERIC_MAPPING GenericMapping);
		[DllImport("advapi32")] public static extern int CreateProcessAsUser(HANDLE hToken, string lpApplicationName, string lpCommandLine, ref Kernel_struct.SECURITY_ATTRIBUTES lpProcessAttributes, ref Kernel_struct.SECURITY_ATTRIBUTES lpThreadAttributes, int bInheritHandles, int dwCreationFlags, string lpEnvironment, string lpCurrentDirectory, ref Kernel_struct.STARTUPINFO lpStartupInfo, ref Kernel_struct.PROCESS_INFORMATION lpProcessInformation);
		...
		[DllImport("advapi32")] public static extern int DeleteAce(ref Kernel_struct.ACL pAcl, int dwAceIndex);
		...
		[DllImport("advapi32")] public static extern int DestroyPrivateObjectSecurity(ref Kernel_struct.SECURITY_DESCRIPTOR ObjectDescriptor);
		...
		[DllImport("advapi32")] public static extern int EnumDependentServices(HANDLE hService, int dwServiceState, ref Kernel_struct.ENUM_SERVICE_STATUS lpServices, int cbBufSize, ref int pcbBytesNeeded, ref int lpServicesReturned);
		[DllImport("advapi32")] public static extern int EnumServicesStatus(HANDLE hSCManager, int dwServiceType, int dwServiceState, ref Kernel_struct.ENUM_SERVICE_STATUS lpServices, int cbBufSize, ref int pcbBytesNeeded, ref int lpServicesReturned, ref int lpResumeHandle);
		...
		[DllImport("advapi32")] public static extern int FindFirstFreeAce(ref Kernel_struct.ACL pAcl, ref int pAce);
		[DllImport("advapi32")] public static extern int GetAce(ref Kernel_struct.ACL pAcl, int dwAceIndex, IntPtr pAce);
		[DllImport("advapi32")] public static extern int GetAclInformation(ref Kernel_struct.ACL pAcl, IntPtr pAclInformation, int nAclInformationLength, short dwAclInformationClass);
		[DllImport("advapi32")] public static extern int GetFileSecurity(string lpFileName, int RequestedInformation, ref Kernel_struct.SECURITY_DESCRIPTOR pSecurityDescriptor, int nLength, ref int lpnLengthNeeded);
		[DllImport("advapi32")] public static extern int GetKernelObjectSecurity(HANDLE handle, int RequestedInformation, ref Kernel_struct.SECURITY_DESCRIPTOR pSecurityDescriptor, int nLength, ref int lpnLengthNeeded);
		...
		[DllImport("advapi32")] public static extern int GetPrivateObjectSecurity(ref Kernel_struct.SECURITY_DESCRIPTOR ObjectDescriptor, int SecurityInformation, Kernel_struct.SECURITY_DESCRIPTOR ResultantDescriptor, int DescriptorLength, int ReturnLength);
		[DllImport("advapi32")] public static extern int GetSecurityDescriptorControl(ref Kernel_struct.SECURITY_DESCRIPTOR pSecurityDescriptor, short pControl, ref int lpdwRevision);
		[DllImport("advapi32")] public static extern int GetSecurityDescriptorDacl(ref Kernel_struct.SECURITY_DESCRIPTOR pSecurityDescriptor, ref int lpbDaclPresent, ref Kernel_struct.ACL pDacl, ref int lpbDaclDefaulted);
		[DllImport("advapi32")] public static extern int GetSecurityDescriptorGroup(ref Kernel_struct.SECURITY_DESCRIPTOR pSecurityDescriptor, IntPtr pGroup, ref int lpbGroupDefaulted);
		[DllImport("advapi32")] public static extern int GetSecurityDescriptorLength(ref Kernel_struct.SECURITY_DESCRIPTOR pSecurityDescriptor);
		[DllImport("advapi32")] public static extern int GetSecurityDescriptorOwner(ref Kernel_struct.SECURITY_DESCRIPTOR pSecurityDescriptor, IntPtr pOwner, ref int lpbOwnerDefaulted);
		[DllImport("advapi32")] public static extern int GetSecurityDescriptorSacl(ref Kernel_struct.SECURITY_DESCRIPTOR pSecurityDescriptor, ref int lpbSaclPresent, ref Kernel_struct.ACL pSacl, ref int lpbSaclDefaulted);
		...
		[DllImport("advapi32")] public static extern int InitializeAcl(ref Kernel_struct.ACL pAcl, int nAclLength, int dwAclRevision);
		[DllImport("advapi32")] public static extern int InitializeSecurityDescriptor(ref Kernel_struct.SECURITY_DESCRIPTOR pSecurityDescriptor, int dwRevision);
		[DllImport("advapi32")] public static extern int InitializeSid(IntPtr Sid, ref Kernel_struct.SID_IDENTIFIER_AUTHORITY pIdentifierAuthority, Byte nSubAuthorityCount);
		...
		[DllImport("advapi32")] public static extern int IsValidAcl(ref Kernel_struct.ACL pAcl);
		[DllImport("advapi32")] public static extern int IsValidSecurityDescriptor(ref Kernel_struct.SECURITY_DESCRIPTOR pSecurityDescriptor);
		...
		[DllImport("advapi32")] public static extern int LookupPrivilegeName(string lpSystemName, ref Kernel_struct.LARGE_INTEGER lpLuid, string lpName, int cbName);
		[DllImport("advapi32")] public static extern int LookupPrivilegeValue(string lpSystemName, string lpName, ref Kernel_struct.LARGE_INTEGER lpLuid);
		[DllImport("advapi32")] public static extern int MakeAbsoluteSD(ref Kernel_struct.SECURITY_DESCRIPTOR pSelfRelativeSecurityDescriptor, ref Kernel_struct.SECURITY_DESCRIPTOR pAbsoluteSecurityDescriptor, ref int lpdwAbsoluteSecurityDescriptorSize, ref Kernel_struct.ACL pDacl, ref int lpdwDaclSize, ref Kernel_struct.ACL pSacl, ref int lpdwSaclSize, IntPtr pOwner, ref int lpdwOwnerSize, IntPtr pPrimaryGroup, ref int lpdwPrimaryGroupSize);
		[DllImport("advapi32")] public static extern int MakeSelfRelativeSD(ref Kernel_struct.SECURITY_DESCRIPTOR pAbsoluteSecurityDescriptor, ref Kernel_struct.SECURITY_DESCRIPTOR pSelfRelativeSecurityDescriptor, ref int lpdwBufferLength);
		...
		[DllImport("advapi32")] public static extern int ObjectPrivilegeAuditAlarm(string SubsystemName, IntPtr HandleId, int ClientToken, int DesiredAccess, Kernel_struct.PRIVILEGE_SET Privileges, int AccessGranted);
		...
		[DllImport("advapi32")] public static extern int PrivilegeCheck(int ClientToken, Kernel_struct.PRIVILEGE_SET RequiredPrivileges, ref int pfResult);
		[DllImport("advapi32")] public static extern int PrivilegedServiceAuditAlarm(string SubsystemName, string ServiceName, int ClientToken, Kernel_struct.PRIVILEGE_SET Privileges, int AccessGranted);
		[DllImport("advapi32")] public static extern int QueryServiceConfig(HANDLE hService, ref Kernel_struct.QUERY_SERVICE_CONFIG lpServiceConfig, int cbBufSize, ref int pcbBytesNeeded);
		[DllImport("advapi32")] public static extern int QueryServiceLockStatus(HANDLE hSCManager, ref Kernel_struct.QUERY_SERVICE_LOCK_STATUS lpLockStatus, int cbBufSize, ref int pcbBytesNeeded);
		...
		[DllImport("advapi32")] public static extern int QueryServiceStatus(HANDLE hService, ref Kernel_struct.SERVICE_STATUS lpServiceStatus);
		[DllImport("advapi32")] public static extern int ReadEventLog(HANDLE hEventLog, int dwReadFlags, int dwRecordOffset, ref Kernel_struct.EVENTLOGRECORD lpBuffer, int nNumberOfBytesToRead, ref int pnBytesRead, ref int pnMinNumberOfBytesNeeded);
		...
		[DllImport("advapi32")] public static extern int RegCreateKeyEx(HANDLE hKey, string lpSubKey, int Reserved, string lpClass, int dwOptions, int samDesired, ref Kernel_struct.SECURITY_ATTRIBUTES lpSecurityAttributes, ref int phkResult, ref int lpdwDisposition);
		...
		[DllImport("advapi32")] public static extern int RegGetKeySecurity(HANDLE hKey, int SecurityInformation, ref Kernel_struct.SECURITY_DESCRIPTOR pSecurityDescriptor, ref int lpcbSecurityDescriptor);
		...
		[DllImport("advapi32")] public static extern int RegSaveKey(HANDLE hKey, string lpFile, ref Kernel_struct.SECURITY_ATTRIBUTES lpSecurityAttributes);
		[DllImport("advapi32")] public static extern int RegSetKeySecurity(HANDLE hKey, int SecurityInformation, ref Kernel_struct.SECURITY_DESCRIPTOR pSecurityDescriptor);
		...
		[DllImport("advapi32")] public static extern int SetAclInformation(ref Kernel_struct.ACL pAcl, IntPtr pAclInformation, int nAclInformationLength, short dwAclInformationClass);
		[DllImport("advapi32")] public static extern int SetFileSecurity(string lpFileName, int SecurityInformation, ref Kernel_struct.SECURITY_DESCRIPTOR pSecurityDescriptor);
		[DllImport("advapi32")] public static extern int SetKernelObjectSecurity(HANDLE handle, int SecurityInformation, Kernel_struct.SECURITY_DESCRIPTOR SecurityDescriptor);
		[DllImport("advapi32")] public static extern int SetPrivateObjectSecurity(int SecurityInformation, Kernel_struct.SECURITY_DESCRIPTOR ModificationDescriptor, Kernel_struct.SECURITY_DESCRIPTOR ObjectsSecurityDescriptor, Kernel_struct.GENERIC_MAPPING GenericMapping, int Token);
		[DllImport("advapi32")] public static extern int SetSecurityDescriptorDacl(ref Kernel_struct.SECURITY_DESCRIPTOR pSecurityDescriptor, int bDaclPresent, ref Kernel_struct.ACL pDacl, int bDaclDefaulted);
		[DllImport("advapi32")] public static extern int SetSecurityDescriptorGroup(ref Kernel_struct.SECURITY_DESCRIPTOR pSecurityDescriptor, IntPtr pGroup, int bGroupDefaulted);
		[DllImport("advapi32")] public static extern int SetSecurityDescriptorOwner(ref Kernel_struct.SECURITY_DESCRIPTOR pSecurityDescriptor, IntPtr pOwner, int bOwnerDefaulted);
		[DllImport("advapi32")] public static extern int SetSecurityDescriptorSacl(ref Kernel_struct.SECURITY_DESCRIPTOR pSecurityDescriptor, int bSaclPresent, ref Kernel_struct.ACL pSacl, int bSaclDefaulted);
		...
		[DllImport("advapi32")] public static extern int SetServiceStatus(HANDLE hServiceStatus, ref Kernel_struct.SERVICE_STATUS lpServiceStatus);
		...
		[DllImport("advapi32")] public static extern int StartServiceCtrlDispatcher(ref Kernel_struct.SERVICE_TABLE_ENTRY lpServiceStartTable);
		...
		[DllImport("advapi32")] public static extern void MapGenericMask(int AccessMask, Kernel_struct.GENERIC_MAPPING GenericMapping);
    ...
    public abstract class Kernel
	{
		...
		[DllImport("kernel32")] public static extern Kernel_struct.COORD GetLargestConsoleWindowSize(HANDLE hConsoleOutput);
		...
		[DllImport("kernel32")] public static extern int BuildCommDCB(string lpDef, ref Kernel_struct.DCB lpDCB);
		[DllImport("kernel32")] public static extern int BuildCommDCBAndTimeouts(string lpDef, ref Kernel_struct.DCB lpDCB, ref Kernel_struct.COMMTIMEOUTS lpCommTimeouts);
		...
		[DllImport("kernel32")] public static extern int ClearCommError(HANDLE hFile, ref int lpErrors, ref Kernel_struct.COMSTAT lpStat);
		[DllImport("kernel32")] public static extern int CloseHandle(HANDLE hObject);
		[DllImport("kernel32")] public static extern int CommConfigDialog(string lpszName, HWND hwnd, ref Kernel_struct.COMMCONFIG lpCC);
		...
		[DllImport("kernel32")] public static extern int ConnectNamedPipe(HANDLE hNamedPipe, ref Kernel_struct.OVERLAPPED lpOverlapped);
		...
		[DllImport("kernel32")] public static extern int CreateConsoleScreenBuffer(int dwDesiredAccess, int dwShareMode, ref Kernel_struct.SECURITY_ATTRIBUTES lpSecurityAttributes, int dwFlags, IntPtr lpScreenBufferData);
		[DllImport("kernel32")] public static extern int CreateDirectory(string lpPathName, ref Kernel_struct.SECURITY_ATTRIBUTES lpSecurityAttributes);
		[DllImport("kernel32")] public static extern int CreateDirectoryEx(string lpTemplateDirectory, string lpNewDirectory, ref Kernel_struct.SECURITY_ATTRIBUTES lpSecurityAttributes);
		[DllImport("kernel32")] public static extern int CreateEvent(ref Kernel_struct.SECURITY_ATTRIBUTES lpEventAttributes, int bManualReset, int bInitialState, string lpName);
		[DllImport("kernel32")] public static extern int CreateFile(string lpFileName, int dwDesiredAccess, int dwShareMode, ref Kernel_struct.SECURITY_ATTRIBUTES lpSecurityAttributes, int dwCreationDisposition, int dwFlagsAndAttributes, HANDLE hTemplateFile);
		[DllImport("kernel32")] public static extern int CreateFileMapping(HANDLE hFile, ref Kernel_struct.SECURITY_ATTRIBUTES lpFileMappigAttributes, int flProtect, int dwMaximumSizeHigh, int dwMaximumSizeLow, string lpName);
		...
		[DllImport("kernel32")] public static extern int CreateMailslot(string lpName, int nMaxMessageSize, int lReadTimeout, ref Kernel_struct.SECURITY_ATTRIBUTES lpSecurityAttributes);
		[DllImport("kernel32")] public static extern int CreateMutex(ref Kernel_struct.SECURITY_ATTRIBUTES lpMutexAttributes, int bInitialOwner, string lpName);
		[DllImport("kernel32")] public static extern int CreateNamedPipe(string lpName, int dwOpenMode, int dwPipeMode, int nMaxInstances, int nOutBufferSize, int nInBufferSize, int nDefaultTimeOut, ref Kernel_struct.SECURITY_ATTRIBUTES lpSecurityAttributes);
		[DllImport("kernel32")] public static extern int CreatePipe(int phReadPipe, int phWritePipe, ref Kernel_struct.SECURITY_ATTRIBUTES lpPipeAttributes, int nSize);
		[DllImport("kernel32")] public static extern int CreateProcess(string lpApplicationName, string lpCommandLine, ref Kernel_struct.SECURITY_ATTRIBUTES lpProcessAttributes, ref Kernel_struct.SECURITY_ATTRIBUTES lpThreadAttributes, int bInheritHandles, int dwCreationFlags, IntPtr lpEnvironment, string lpCurrentDriectory, ref Kernel_struct.STARTUPINFO lpStartupInfo, ref Kernel_struct.PROCESS_INFORMATION lpProcessInformation);
		[DllImport("kernel32")] public static extern int CreateRemoteThread(HANDLE hProcess, ref Kernel_struct.SECURITY_ATTRIBUTES lpThreadAttributes, int dwStackSize, ref int lpStartAddress, IntPtr lpParameter, int dwCreationFlags, ref int lpThreadId);
		[DllImport("kernel32")] public static extern int CreateSemaphore(ref Kernel_struct.SECURITY_ATTRIBUTES lpSemaphoreAttributes, int lInitialCount, int lMaximumCount, string lpName);
		...
		[DllImport("kernel32")] public static extern int CreateThread(ref Kernel_struct.SECURITY_ATTRIBUTES lpThreadAttributes, int dwStackSize, ref int lpStartAddress, IntPtr lpParameter, int dwCreationFlags, ref int lpThreadId);
		...
		[DllImport("kernel32")] public static extern int DeviceIoControl(HANDLE hDevice, int dwIoControlCode, IntPtr lpInBuffer, int nInBufferSize, IntPtr lpOutBuffer, int nOutBufferSize, ref int lpBytesReturned, ref Kernel_struct.OVERLAPPED lpOverlapped);
		...
		[DllImport("kernel32")] public static extern int FileTimeToSystemTime(ref FILETIME lpFileTime, ref User.Struct.SYSTEMTIME lpSystemTime);
		[DllImport("kernel32")] public static extern int FillConsoleOutputAttribute(HANDLE hConsoleOutput, int wAttribute, int nLength, Kernel_struct.COORD dwWriteCoord, ref int lpNumberOfAttrsWritten);
		[DllImport("kernel32")] public static extern int FillConsoleOutputCharacter(HANDLE hConsoleOutput, Byte cCharacter, int nLength, Kernel_struct.COORD dwWriteCoord, ref int lpNumberOfCharsWritten);
		...
		[DllImport("kernel32")] public static extern int FindFirstFile(string lpFileName, Kernel_struct.WIN32_FIND_DATA lpFindFileData);
		[DllImport("kernel32")] public static extern int FindNextChangeNotification(HANDLE hChangeHandle);
		[DllImport("kernel32")] public static extern int FindNextFile(HANDLE hFindFile, Kernel_struct.WIN32_FIND_DATA lpFindFileData);
        ...
        [DllImport("kernel32", SetLastError = true, CharSet = CharSet.Auto)] public static extern uint GetAtomName(ushort nAtom, [Out] StringBuilder lpBuffer, int nSize);


		[DllImport("kernel32")] public static extern int GetBinaryType(string lpApplicationName, ref int lpBinaryType);
		[DllImport("kernel32")] public static extern int GetCPInfo(int CodePage, ref Kernel_struct.CPINFO lpCPInfo);
		[DllImport("kernel32")] public static extern int GetCommConfig(HANDLE hCommDev, ref Kernel_struct.COMMCONFIG lpCC, ref int lpdwSize);
		...
		[DllImport("kernel32")] public static extern int GetCommProperties(HANDLE hFile, ref Kernel_struct.COMMPROP lpCommProp);
		[DllImport("kernel32")] public static extern int GetCommState(int nCid, ref Kernel_struct.DCB lpDCB);
		[DllImport("kernel32")] public static extern int GetCommTimeouts(HANDLE hFile, ref Kernel_struct.COMMTIMEOUTS lpCommTimeouts);
		...
		[DllImport("kernel32")] public static extern int GetConsoleCursorInfo(HANDLE hConsoleOutput, ref Kernel_struct.CONSOLE_CURSOR_INFO lpConsoleCursorInfo);
		...
		[DllImport("kernel32")] public static extern int GetConsoleScreenBufferInfo(HANDLE hConsoleOutput, ref Kernel_struct.CONSOLE_SCREEN_BUFFER_INFO lpConsoleScreenBufferInfo);
		[DllImport("kernel32")] public static extern int GetConsoleTitle(string lpConsoleTitle, int nSize);
		[DllImport("kernel32")] public static extern int GetCurrencyFormat(int Locale, int dwFlags, string lpValue, ref Kernel_struct.CURRENCYFMT lpFormat, string lpCurrencyStr, int cchCurrency);
		...
		[DllImport("kernel32")] public static extern int GetDateFormat(int Locale, int dwFlags, ref User.Struct.SYSTEMTIME lpDate, string lpFormat, string lpDateStr, int cchDate);
		[DllImport("kernel32")] public static extern int GetDefaultCommConfig(string lpszName, ref Kernel_struct.COMMCONFIG lpCC, ref int lpdwSize);
		...
		[DllImport("kernel32")] public static extern int GetFileInformationByHandle(HANDLE hFile, ref Kernel_struct.BY_HANDLE_FILE_INFORMATION lpFileInformation);
		...
		[DllImport("kernel32")] public static extern int GetNumberFormat(int Locale, int dwFlags, string lpValue, ref Kernel_struct.NUMBERFMT lpFormat, string lpNumberStr, int cchNumber);
		...
		[DllImport("kernel32")] public static extern int GetOverlappedResult(HANDLE hFile, ref Kernel_struct.OVERLAPPED lpOverlapped, ref int lpNumberOfBytesTransferred, int bWait);
		...
		[DllImport("kernel32")] public static extern int GetSystemPowerStatus(ref Kernel_struct.SYSTEM_POWER_STATUS lpSystemPowerStatus);
		...
		[DllImport("kernel32")] public static extern int GetThreadContext(HANDLE hThread, ref Kernel_struct.CONTEXT lpContext);
		[DllImport("kernel32")] public static extern int GetThreadPriority(HANDLE hThread);
		[DllImport("kernel32")] public static extern int GetThreadSelectorEntry(HANDLE hThread, int dwSelector, ref Kernel_struct.LDT_ENTRY lpSelectorEntry);
		...
		[DllImport("kernel32")] public static extern int GetTimeFormat(int Locale, int dwFlags, ref User.Struct.SYSTEMTIME lpTime, string lpFormat, string lpTimeStr, int cchTime);
		[DllImport("kernel32")] public static extern int GetTimeZoneInformation(ref Kernel_struct.TIME_ZONE_INFORMATION lpTimeZoneInformation);
		[DllImport("kernel32")] public static extern int GetUserDefaultLCID();
		[DllImport("kernel32")] public static extern int GetVersion();
		[DllImport("kernel32")] public static extern int GetVersionEx(ref Kernel_struct.OSVERSIONINFO lpVersionInformation);
		...
		[DllImport("kernel32")] public static extern int LockFileEx(HANDLE hFile, int dwFlags, int dwReserved, int nNumberOfBytesToLockLow, int nNumberOfBytesToLockHigh, ref Kernel_struct.OVERLAPPED lpOverlapped);
		...
		[DllImport("kernel32")] public static extern int OpenFile(string lpFileName, ref Kernel_struct.OFSTRUCT lpReOpenBuff, int wStyle);
		...
		[DllImport("kernel32")] public static extern int QueryPerformanceCounter(ref Kernel_struct.LARGE_INTEGER lpPerformanceCount);
		...
		[DllImport("kernel32")] public static extern int ReadConsoleOutput(HANDLE hConsoleOutput, ref Kernel_struct.CHAR_INFO lpBuffer, Kernel_struct.COORD dwBufferSize, Kernel_struct.COORD dwBufferCoord, ref Kernel_struct.SMALL_RECT lpReadRegion);
		...
		[DllImport("kernel32")] public static extern int ReadConsoleOutputCharacter(HANDLE hConsoleOutput, string lpCharacter, int nLength, Kernel_struct.COORD dwReadCoord, ref int lpNumberOfCharsRead);
		[DllImport("kernel32")] public static extern int ReadFile(HANDLE hFile, IntPtr lpBuffer, int nNumberOfBytesToRead, ref int lpNumberOfBytesRead, ref Kernel_struct.OVERLAPPED lpOverlapped);
		[DllImport("kernel32")] public static extern int ReadFileEx(HANDLE hFile, IntPtr lpBuffer, int nNumberOfBytesToRead, ref Kernel_struct.OVERLAPPED lpOverlapped, ref int lpCompletionRoutine);
		...
		[DllImport("kernel32")] public static extern int SetLocalTime(ref User.Struct.SYSTEMTIME lpSystemTime);
		...
		[DllImport("kernel32")] public static extern int SetSystemTime(ref User.Struct.SYSTEMTIME lpSystemTime);
		...
		[DllImport("kernel32")] public static extern int VirtualQuery(IntPtr lpAddress, ref Kernel_struct.MEMORY_BASIC_INFORMATION lpBuffer, int dwLength);
		...
		[DllImport("kernel32")] public static extern void DeleteCriticalSection(ref Kernel_struct.CRITICAL_SECTION lpCriticalSection);
		[DllImport("kernel32")] public static extern void EnterCriticalSection(ref Kernel_struct.CRITICAL_SECTION lpCriticalSection);
		...
		[DllImport("kernel32")] public static extern void GetLocalTime(ref User.Struct.SYSTEMTIME lpSystemTime);
		...
		[DllImport("kernel32")] public static extern void GetSystemTime(ref User.Struct.SYSTEMTIME lpSystemTime);
		...
		[DllImport("kernel32")] public static extern void InitializeCriticalSection(ref Kernel_struct.CRITICAL_SECTION lpCriticalSection);
