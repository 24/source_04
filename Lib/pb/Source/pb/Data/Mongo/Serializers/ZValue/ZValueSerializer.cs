...
{
    // ZValueSerializer est-il vraiment utilisé
    //   Serialize() :
    //     new pb.Data.ZString("toto").zTraceJson();        n'utilise pas ZValueSerializer.Serialize()
    //     Test_MongoSerializers.Test_ZValue_01();          n'utilise pas ZValueSerializer.Serialize()
    //   Deserialize()
    //     Test_ZValue value = BsonSerializer.Deserialize<Test_ZValue>("{ value1: \"toto\", value2: 123 }");            utilise ZValueSerializer.Deserialize()
    // from BsonValueSerializer
    // IBsonDocumentSerializer -> GetMemberSerializationInfo()
    // IBsonArraySerializer    -> GetItemSerializationInfo()
    public class ZValueSerializer : BsonBaseSerializer
    {
        private static bool _trace = false;
        private static ZValueSerializer _instance = new ZValueSerializer();
        ...
        /// </summary>
        public static ZValueSerializer Instance { get { return _instance; } }
        ...
        {
            if (_trace)
                pb.Trace.WriteLine("ZValueSerializer.Deserialize()");
        ...
        //{
        //    if (_trace)
        //        pb.Trace.WriteLine("ZValueSerializer.GetMemberSerializationInfo()");
        ...
        //{
        //    if (_trace)
        //        pb.Trace.WriteLine("ZValueSerializer.GetItemSerializationInfo()");
        //    return new BsonSerializationInfo(
        //        null,
        //        ZValueSerializer.Instance,
        //        typeof(BsonValue),
