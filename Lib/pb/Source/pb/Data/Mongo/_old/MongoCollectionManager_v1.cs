...
namespace pb.Data.Mongo.old
{
    ...
    // ATTENTION l'utilisation de MongoIntIdGenerator ajoute un document dans la collection pour gérer le last id
    ...
    public class MongoCollectionManager_v1<TKey, TData>
    {
        ...
        private MongoIntIdGenerator_v2 _idGenerator = null;
