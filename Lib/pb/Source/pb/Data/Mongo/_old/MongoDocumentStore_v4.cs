...
namespace pb.Data.Mongo.old
{
    ...
    public class MongoDocumentStore_v4<TKey, TData> : IDocumentStore_v4<TKey, TData>
    {
        ...
        public MongoDocumentStore_v4(string server, string database, string collectionName, string itemName = null)
        {
            _server = server;
            _database = database;
        ...
        public static MongoDocumentStore_v4<TKey, TData> Create(XElement xe)
        {
            if (xe.zXPathValue("UseMongo").zTryParseAs(false))
            {
                MongoDocumentStore_v4<TKey, TData> documentStore = new MongoDocumentStore_v4<TKey, TData>(xe.zXPathValue("MongoServer"), xe.zXPathValue("MongoDatabase"), xe.zXPathValue("MongoCollection"), xe.zXPathValue("MongoDocumentItemName"));
