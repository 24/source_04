...
namespace pb.Data.Mongo.old
{
    ...
    //   { _id: 0, LastId: 123 }
    public class MongoIntIdGenerator_v2
    {
        ...
        public MongoIntIdGenerator_v2(string collectionName, string databaseName, string serverName = null)
        {
        ...
        public MongoIntIdGenerator_v2(MongoCollection collection)
        {
