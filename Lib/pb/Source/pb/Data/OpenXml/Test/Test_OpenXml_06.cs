...
{
    public static class Test_OpenXml_06
    {
        ...
        {
            //_directory = zPath.Combine(RunSource.CurrentRunSource.ProjectDirectory, "docs\\Test_OpenXml_06");
            _directory = zPath.Combine(_directoryBase, "docs\\Test_OpenXml_06");
        ...
        public static void Test_01()
        {
            ...
            Trace.WriteLine("create docx \"{0}\" using zOpenXmlDoc", file);
            zOpenXmlDoc.Create(zPath.Combine(_directory, file), GetDocXElements_01());
        }
        ...
        public static void Test_02()
        {
            ...
            Trace.WriteLine("create docx \"{0}\" using zOpenXmlDoc", file);
            zOpenXmlDoc.Create(zPath.Combine(_directory, file), GetDocXElements_02());
        }

        public static IEnumerable<zDocXElement> GetDocXElements_02()
        {
            ...
            yield return new zDocXTextElement { Text = "Direction Kazanlak. Le paysage est splendide avec de superbes montagnes." };
            yield return new zDocXElement { Type = zDocXElementType.Paragraph };
            ...
            yield return new zDocXElement { Type = zDocXElementType.Paragraph };
            yield return new zDocXTextElement { Text = "Dodo sous la tombe thrace après que Charlotte ait joué au super héros en haut du toi pour y accrocher 3 vélos... sans bloquer les fenêtres de toit... mais en coinçant le coffre de toit... récupérer les planches sera difficile..." };
            yield return new zDocXElement { Type = zDocXElementType.Line };
            yield return new zDocXTextElement { Text = "1h18..." };
            yield return new zDocXElement { Type = zDocXElementType.Line };
            yield return new zDocXTextElement { Text = "leka nohst" };
        }
