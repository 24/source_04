    ...
    public static class Test_OpenXml_Style
    {
        ...
        public static void Test_Style_01()
        {
            ...
            using (WordprocessingDocument doc = WordprocessingDocument.Create(zPath.Combine(_directory, file), WordprocessingDocumentType.Document))
            {
                ...
                Test_OXmlCreator.SetSectionPage(sectionProperties);
                ...
                Styles styles = Test_OXmlCreator.CreateStyles(mainPart);
                ...
                styles.Append(Test_OXmlCreator.CreateTinyParagraphStyle(tinyParagraphStyleId));
                ...
                body.Append(Test_OXmlCreator.CreateText_01(paragraphProperties));
            }
        }
        ...
        public static void Test_DocDefaults_01()
        {
            ...
            using (WordprocessingDocument doc = WordprocessingDocument.Create(zPath.Combine(_directory, file), WordprocessingDocumentType.Document))
            {
                ...
                //AddText(body);
                body.Append(Test_OXmlCreator.CreateText_01());
            }
        }
        ...
        public static void Test_Formule_01(string formule)
        {
            ...
            using (WordprocessingDocument doc = WordprocessingDocument.Create(zPath.Combine(_directory, file), WordprocessingDocumentType.Document))
            {
                ...
                body.Append(Test_OXmlCreator.CreateText_02(5));
                body.Append(Test_OXmlCreator.CreateParagraph_Formule("test : ", formule));
            }
        ...
        public static void Test_Header_01(bool header = false, bool footer = false, bool pageNumber = false)
        {
            ...
            using (WordprocessingDocument doc = WordprocessingDocument.Create(zPath.Combine(_directory, file), WordprocessingDocumentType.Document))
            {
                ...
                if (header)
                {
                    ...
                    styles.Append(Test_OXmlCreator.CreateHeaderFooterStyle(headerStyleId));
                }
                ...
                if (footer)
                {
                    ...
                    styles.Append(Test_OXmlCreator.CreateHeaderFooterStyle(footerStyleId));
                }
                ...
                if (header)
                {
                    defaultHeaderPartId = Test_OXmlCreator.CreateHeader(mainPart, Test_OXmlCreator.CreateParagraph_01(headerStyleId, "Default header", tab: 1));
                    firstHeaderPartId = Test_OXmlCreator.CreateHeader(mainPart, Test_OXmlCreator.CreateParagraph_01(headerStyleId, "First header", tab: 1));
                    evenHeaderPartId = Test_OXmlCreator.CreateHeader(mainPart, Test_OXmlCreator.CreateParagraph_01(headerStyleId, "Even header", tab: 1));
                }
                ...
                if (footer)
                {
                    ...
                    if (pageNumber)
                        element = Test_OXmlCreator.CreateParagraph_PageNumber(footerStyleId, "Default footer");
                    else
                        element = Test_OXmlCreator.CreateParagraph_01(footerStyleId, "Default footer", tab: 1);
                    defaultFooterPartId = Test_OXmlCreator.CreateFooter(mainPart, element);

                    if (pageNumber)
                        element = Test_OXmlCreator.CreateParagraph_PageNumber(footerStyleId, "First footer");
                    else
                        element = Test_OXmlCreator.CreateParagraph_01(footerStyleId, "First footer", tab: 1);
                    firstFooterPartId = Test_OXmlCreator.CreateFooter(mainPart, element);

                    if (pageNumber)
                        element = Test_OXmlCreator.CreateParagraph_PageNumber(footerStyleId, "Even footer");
                    else
                        element = Test_OXmlCreator.CreateParagraph_01(footerStyleId, "Even footer", tab: 1);
                    evenFooterPartId = Test_OXmlCreator.CreateFooter(mainPart, element);
                }
                ...
                SectionProperties sectionProperties = body.AppendChild(new SectionProperties());
                Test_OXmlCreator.SetSectionPage(sectionProperties);
                Test_OXmlCreator.SetSectionHeaders(sectionProperties, defaultHeaderPartId, defaultFooterPartId, firstHeaderPartId, firstFooterPartId, evenHeaderPartId, evenFooterPartId);
                //Test_OXmlCreator.SetSectionPageNumberType(sectionProperties, start: 1);

                //AddText(body, 200);
                body.Append(Test_OXmlCreator.CreateText_02(200));
            }
        }
    }
}
