...
namespace pb.Data
{
    ...
    public static class ParseNamedValues
    {
        static ParseNamedValues()
        {
            InitParseValues();
        }
    ...
    public static class NamedValuesExtension
    {
        public static IEnumerable<object> zToValues(this NamedValues<ZValue> namedValues)
        {
            return namedValues.Values.Select(value => value.ToObject());
        }
    }
}
