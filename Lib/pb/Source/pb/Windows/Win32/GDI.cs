...
{
    #region Gdi_const
    public abstract class Gdi_const
    {
    ...
    #region class Gdi_struct
    public abstract class Gdi_struct
    {
        ...
        #region struct BITMAPCOREHEADER
        ...
        #region struct BITMAPFILEHEADER
        ...
        #region struct ENHMETAHEADER
        public struct ENHMETAHEADER
        {
            public int iType;
            public int nSize;
            public User.Struct.RECT rclBounds;
            public User.Struct.RECT rclFrame;
            ...
            public User.Struct.SIZE szlDevice;
            public User.Struct.SIZE szlMillimeters;
        }
        #endregion

        #region struct TEXTMETRIC
        ...
        #region struct LOGPEN
        public struct LOGPEN
        {
            public int lopnStyle;
            public User.Struct.POINT lopnWidth;
            public int lopnColor;
        }
        #endregion

        #region struct EXTLOGPEN
        ...
        public struct LOGFONT
        {
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = Gdi_const.LF_FACESIZE)]
            public byte[] lfFaceName;
        }
        #endregion

        #region struct NONCLIENTMETRICS
        ...
        #region struct ENUMLOGFONT
        public struct ENUMLOGFONT
        {
            public LOGFONT elfLogFont;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = Gdi_const.LF_FULLFACESIZE)]
        ...
        public struct EXTLOGFONT
        {
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = Gdi_const.ELF_VENDOR_SIZE)]
        ...
        public struct DEVMODE
        {
            ...
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = Gdi_const.CCHFORMNAME)]
        ...
        public struct RGNDATAHEADER
        {
            ...
            public int nCount;
            public int nRgnSize;
            public User.Struct.RECT rcBound;
        }
        #endregion

        #region struct RGNDATA
        ...
        #region struct OUTLINETEXTMETRIC
        public struct OUTLINETEXTMETRIC
        {
            ...
            public User.Struct.RECT otmrcFontBox;
            public int otmMacAscent;
            public int otmMacDescent;
            public int otmMacLineGap;
            public int otmusMinimumPPEM;
            public User.Struct.POINT otmptSubscriptSize;
            public User.Struct.POINT otmptSubscriptOffset;
            public User.Struct.POINT otmptSuperscriptSize;
            public User.Struct.POINT otmptSuperscriptOffset;
        ...
        #region struct GLYPHMETRICS
        public struct GLYPHMETRICS
        {
            public int gmBlackBoxX;
            public int gmBlackBoxY;
            public User.Struct.POINT gmptGlyphOrigin;
            public short gmCellIncX;
            public short gmCellIncY;
        }
        #endregion

        #region struct POINTFX
        ...
        #region struct RASTERIZER_STATUS
    ...
    public abstract class Gdi
	{
		...
		[DllImport("gdi32")] public static extern int AnimatePalette(HANDLE hPalette, int wStartIndex, int wNumEntries, Gdi_struct.PALETTEENTRY[] lpPaletteColors);
		...
		[DllImport("gdi32")] public static extern int ChoosePixelFormat(HWND hdc, ref Gdi_struct.PIXELFORMATDESCRIPTOR pPixelFormatDescriptor);
		...
		[DllImport("gdi32")] public static extern int CombineTransform(ref Gdi_struct.XFORM lpxformResult, ref Gdi_struct.XFORM lpxform1, ref Gdi_struct.XFORM lpxform2);
		...
		[DllImport("gdi32")] public static extern int CreateBitmapIndirect(ref Gdi_struct.BITMAP lpBitmap);
		[DllImport("gdi32")] public static extern int CreateBrushIndirect(ref Gdi_struct.LOGBRUSH lpLogBrush);
		[DllImport("gdi32")] public static extern int CreateColorSpace(ref Gdi_struct.LOGCOLORSPACE lplogcolorspace);
		...
		[DllImport("gdi32")] public static extern int CreateDC(string lpDriverName, string lpDeviceName, string lpOutput, ref Gdi_struct.DEVMODE lpInitData);
		...
		[DllImport("gdi32")] public static extern int CreateDIBSection(HWND hdc, ref Gdi_struct.BITMAPINFO pBitmapInfo, int un, ref IntPtr lplpVoid, HANDLE handle, int dw);
		[DllImport("gdi32")] public static extern int CreateDIBitmap(HDC hdc, ref Gdi_struct.BITMAPINFOHEADER lpInfoHeader, int dwUsage, IntPtr lpInitBits, ref Gdi_struct.BITMAPINFO lpInitInfo, int wUsage);
		...
		[DllImport("gdi32")] public static extern int CreateEllipticRgnIndirect(ref User.Struct.RECT lpRect);
		[DllImport("gdi32")] public static extern int CreateEnhMetaFile(HWND hdcRef, string lpFileName, ref User.Struct.RECT lpRect, string lpDescription);
		...
		[DllImport("gdi32")] public static extern int CreateFontIndirect(ref Gdi_struct.LOGFONT lpLogFont);
		...
		[DllImport("gdi32")] public static extern int CreateIC(string lpDriverName, string lpDeviceName, string lpOutput, ref Gdi_struct.DEVMODE lpInitData);
		[DllImport("gdi32")] public static extern int CreateMetaFile(string lpString);
		[DllImport("gdi32")] public static extern int CreatePalette(ref Gdi_struct.LOGPALETTE lpLogPalette);
		...
		[DllImport("gdi32")] public static extern int CreatePenIndirect(ref Gdi_struct.LOGPEN lpLogPen);
		[DllImport("gdi32")] public static extern int CreatePolyPolygonRgn(ref User.Struct.POINT lpPoint, ref int lpPolyCounts, int nCount, int nPolyFillMode);
		[DllImport("gdi32")] public static extern int CreatePolygonRgn(ref User.Struct.POINT lpPoint, int nCount, int nPolyFillMode);
		[DllImport("gdi32")] public static extern int CreateRectRgn(int X1, int Y1, int X2, int Y2);
		[DllImport("gdi32")] public static extern int CreateRectRgnIndirect(ref User.Struct.RECT lpRect);
		...
		[DllImport("gdi32")] public static extern int DPtoLP(HDC hdc, ref User.Struct.POINT lpPoint, int nCount);
		...
		[DllImport("gdi32")] public static extern int DescribePixelFormat(HWND hdc, int n, int un, ref Gdi_struct.PIXELFORMATDESCRIPTOR lpPixelFormatDescriptor);
		...
		[DllImport("gdi32")] public static extern int EnumEnhMetaFile(HDC hdc, HANDLE hemf, ref int lpEnhMetaFunc, IntPtr lpData, ref User.Struct.RECT lpRect);
		[DllImport("gdi32")] public static extern int EnumFontFamilies(HDC hdc, string lpszFamily, ref int lpEnumFontFamProc, int lParam);
		[DllImport("gdi32")] public static extern int EnumFontFamiliesEx(HDC hdc, ref Gdi_struct.LOGFONT lpLogFont, ref int lpEnumFontProc, int lParam, int dw);
		...
		[DllImport("gdi32")] public static extern int ExtCreatePen(int dwPenStyle, int dwWidth, ref Gdi_struct.LOGBRUSH lplb, int dwStyleCount, ref int lpStyle);
		...
		[DllImport("gdi32")] public static extern int ExtTextOut(HDC hdc, int x, int y, int wOptions, ref User.Struct.RECT lpRect, string lpString, int nCount, ref int lpDx);
		...
		[DllImport("gdi32")] public static extern int FixBrushOrgEx(HWND hdc, int n1, int n2, ref User.Struct.POINT lpPoint);
		...
		[DllImport("gdi32")] public static extern int GetAspectRatioFilterEx(HDC hdc, ref User.Struct.SIZE lpAspectRatio);
		[DllImport("gdi32")] public static extern int GetBitmapBits(HANDLE hBitmap, int dwCount, IntPtr lpBits);
		[DllImport("gdi32")] public static extern int GetBitmapDimensionEx(HANDLE hBitmap, ref User.Struct.SIZE lpDimension);
		[DllImport("gdi32")] public static extern int GetBkColor(HDC hdc);
		[DllImport("gdi32")] public static extern int GetBkMode(HDC hdc);
		[DllImport("gdi32")] public static extern int GetBoundsRect(HDC hdc, ref User.Struct.RECT lprcBounds, int flags);
		...
		[DllImport("gdi32")] public static extern int GetColorAdjustment(HDC hdc, ref Gdi_struct.COLORADJUSTMENT lpca);
		...
		[DllImport("gdi32")] public static extern int GetDIBColorTable(HWND hdc, int un1, int un2, ref Gdi_struct.RGBQUAD pRGBQuad);
		[DllImport("gdi32")] public static extern int GetDIBits(int aHDC, HANDLE hBitmap, int nStartScan, int nNumScans, IntPtr lpBits, ref Gdi_struct.BITMAPINFO lpBI, int wUsage);
		...
		[DllImport("gdi32")] public static extern int GetPaletteEntries(HANDLE hPalette, int wStartIndex, int wNumEntries, ref Gdi_struct.PALETTEENTRY lpPaletteEntries);
		...
		[DllImport("gdi32")] public static extern int GetTextExtentPoint(HDC hdc, string lpszString, int cbString, ref User.Struct.SIZE lpSize);
		...
		[DllImport("gdi32")] public static extern int GetViewportOrgEx(HDC hdc, ref User.Struct.POINT lpPoint);
		...
		[DllImport("gdi32")] public static extern int GetWindowExtEx(HDC hdc, ref User.Struct.SIZE lpSize);
		[DllImport("gdi32")] public static extern int GetWindowOrgEx(HDC hdc, ref User.Struct.POINT lpPoint);
		[DllImport("gdi32")] public static extern int GetWorldTransform(HDC hdc, ref Gdi_struct.XFORM lpXform);
		...
		[DllImport("gdi32")] public static extern int LPtoDP(HDC hdc, ref User.Struct.POINT lpPoint, int nCount);
		...
		[DllImport("gdi32")] public static extern int OffsetWindowOrgEx(HDC hdc, int nX, int nY, ref User.Struct.POINT lpPoint);
		...
		[DllImport("gdi32")] public static extern int PlayEnhMetaFileRecord(HDC hdc, ref Gdi_struct.HANDLETABLE lpHandletable, ref Gdi_struct.ENHMETARECORD lpEnhMetaRecord, int nHandles);
		...
		[DllImport("gdi32")] public static extern int PolyBezierTo(HDC hdc, ref User.Struct.POINT lppt, int cCount);
		[DllImport("gdi32")] public static extern int PolyDraw(HDC hdc, ref User.Struct.POINT lppt, Byte lpbTypes, int cCount);
		[DllImport("gdi32")] public static extern int PolyPolygon(HDC hdc, ref User.Struct.POINT lpPoint, ref int lpPolyCounts, int nCount);
		...
		[DllImport("gdi32")] public static extern int Polyline(HDC hdc, ref User.Struct.POINT lpPoint, int nCount);
		...
		[DllImport("gdi32")] public static extern int ScaleViewportExtEx(HDC hdc, int nXnum, int nXdenom, int nYnum, int nYdenom, ref User.Struct.SIZE lpSize);
		...
		[DllImport("gdi32")] public static extern int SetViewportExtEx(HDC hdc, int nX, int nY, ref User.Struct.SIZE lpSize);
		[DllImport("gdi32")] public static extern int SetViewportOrgEx(HDC hdc, int nX, int nY, ref User.Struct.POINT lpPoint);
