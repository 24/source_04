...
namespace pb.Windows.Win32
{
    ...
    public abstract class UserConst
    {
        ...
        // Ddeml.h (c:\Program Files\Microsoft SDKs\Windows\v6.1\Include\)

        // Ddeml.h : Application command flags
        ...
        // Ddeml.h : Application classification flags
        public const uint APPCLASS_STANDARD            = 0x00000000;
        public const uint APPCLASS_MASK                = 0x0000000F;
        ...
        public const int WM_DDE_LAST = (WM_DDE_FIRST + 8); // 0x3E0 + 8 = 0x3E8
    ...
    ******************************************************************************/
    ...
    public abstract partial class User
	{
        ...
        //public static extern int SendInput(int nInputs, ref User_struct.INPUT pInputs, int cbSize);

        [DllImport("user32", SetLastError = true)] public static extern uint SendInput(uint nInputs, User.Struct.INPUT[] pInputs, int cbSize);

        [DllImport("user32")] public static extern bool GetGUIThreadInfo(uint idThread, out User.Struct.GUITHREADINFO lpgui);
        // fin ajout
		...
		[DllImport("user32")] public static extern int AdjustWindowRect(ref User.Struct.RECT lpRect, int dwStyle, int bMenu);
		[DllImport("user32")] public static extern int AdjustWindowRectEx(ref User.Struct.RECT lpRect, int dsStyle, int bMenu, int dwEsStyle);
        ...
        [DllImport("user32")] public static extern int BeginPaint(HWND hwnd, ref User.Struct.PAINTSTRUCT lpPaint);
		...
		[DllImport("user32")] public static extern int CallMsgFilter(ref User.Struct.MSG lpMsg, int ncode);
		...
		[DllImport("user32")] public static extern int ClientToScreen(HWND hwnd, ref User.Struct.POINT lpPoint);
		[DllImport("user32")] public static extern int ClipCursor(ref User.Struct.RECT lpRect);
        ...
        [DllImport("user32", SetLastError = true)] public static extern int CloseWindow(IntPtr hWnd);

		[DllImport("user32")] public static extern int CloseWindowStation(HANDLE hWinSta);
		[DllImport("user32")] public static extern int CopyAcceleratorTable(HANDLE hAccelSrc, User.Struct.ACCEL[] lpAccelDst, int cAccelEntries);
		...
		[DllImport("user32")] public static extern int CopyRect(ref User.Struct.RECT lpDestRect, ref User.Struct.RECT lpSourceRect);
		[DllImport("user32")] public static extern int CountClipboardFormats();
		[DllImport("user32")] public static extern int CreateAcceleratorTable(ref User.Struct.ACCEL lpaccl, int cEntries);
		...
		[DllImport("user32")] public static extern int CreateDialogIndirectParam(HANDLE hInstance, ref User.Struct.DLGTEMPLATE lpTemplate, HWND hwndParent, ref int lpDialogFunc, int dwInitParam);
		...
		[DllImport("user32")] public static extern int CreateIconIndirect(ref User.Struct.ICONINFO piconinfo);
		...
		[DllImport("user32")] public static extern int DdeConnect(int idInst, HANDLE hszService, HANDLE hszTopic, ref User.Struct.CONVCONTEXT pCC);
		[DllImport("user32")] public static extern int DdeConnectList(int idInst, HANDLE hszService, HANDLE hszTopic, HANDLE hConvList, ref User.Struct.CONVCONTEXT pCC);
		...
		[DllImport("user32")] public static extern int DdeQueryConvInfo(HANDLE hConv, int idTransaction, ref User.Struct.CONVINFO pConvInfo);
		...
		[DllImport("user32")] public static extern int DdeSetQualityOfService(HWND hwndClient, ref User.Struct.SECURITY_QUALITY_OF_SERVICE pqosNew, ref User.Struct.SECURITY_QUALITY_OF_SERVICE pqosPrev);
		...
		[DllImport("user32")] public static extern int DestroyWindow(IntPtr hWnd);

		[DllImport("user32")] public static extern int DialogBoxIndirectParam(HANDLE hInstance, User.Struct.DLGTEMPLATE hDialogTemplate, HWND hwndParent, ref int lpDialogFunc, int dwInitParam);
		[DllImport("user32")] public static extern int DispatchMessage(ref User.Struct.MSG lpMsg);
		...
		[DllImport("user32")] public static extern int DragDetect(HWND hwnd, User.Struct.POINT pt);
		[DllImport("user32")] public static extern int DragObject(HWND hwnd1, HWND hwnd2, int un, int dw, HANDLE hCursor);
		[DllImport("user32")] public static extern int DrawAnimatedRects(HWND hwnd, int idAni, ref User.Struct.RECT lprcFrom, ref User.Struct.RECT lprcTo);
		[DllImport("user32")] public static extern int DrawCaption(HWND hwnd, HWND hdc, ref User.Struct.RECT pcRect, int un);
		[DllImport("user32")] public static extern int DrawEdge(HDC hdc, ref User.Struct.RECT qrc, int edge, int grfFlags);
		[DllImport("user32")] public static extern int DrawFocusRect(HDC hdc, ref User.Struct.RECT lpRect);
		[DllImport("user32")] public static extern int DrawFrameControl(HWND hdc, ref User.Struct.RECT lpRect, int un1, int un2);
		...
		[DllImport("user32")] public static extern int DrawText(HDC hdc, string lpStr, int nCount, ref User.Struct.RECT lpRect, int wFormat);
		[DllImport("user32")] public static extern int DrawTextEx(HWND hdc, string lpsz, int n, ref User.Struct.RECT lpRect, int un, ref User.Struct.DRAWTEXTPARAMS lpDrawTextParams);
		...
		[DllImport("user32")] public static extern int EndPaint(HWND hwnd, ref User.Struct.PAINTSTRUCT lpPaint);

        public delegate bool EnumWindowsCallBackType(IntPtr hWnd, IntPtr lParam);

        //[DllImport("user32")] public static extern int EnumChildWindows(HWND hwndParent, ref int lpEnumFunc, int lParam);
        [DllImport("user32")] [return: MarshalAs(UnmanagedType.Bool)] public static extern bool EnumChildWindows(IntPtr hwndParent, EnumWindowsCallBackType callBack, IntPtr lParam);
        ...
        [DllImport("user32.dll")] public static extern bool EnumDesktopWindows(IntPtr hDesktop, EnumWindowsCallBackType callBack, IntPtr lParam);
        ...
        [DllImport("user32.dll")] [return: MarshalAs(UnmanagedType.Bool)] public static extern bool EnumThreadWindows(uint dwThreadId, EnumWindowsCallBackType callBack, IntPtr lParam);
        ...
        //[DllImport("user32")] public static extern int EnumWindows(EnumWindowsCallBackType callBack, int lParam);
        [DllImport("user32")] [return: MarshalAs(UnmanagedType.Bool)] public static extern bool EnumWindows(EnumWindowsCallBackType callBack, IntPtr lParam);

		[DllImport("user32")] public static extern int EqualRect(ref User.Struct.RECT lpRect1, ref User.Struct.RECT lpRect2);
		...
		[DllImport("user32")] public static extern int FillRect(HDC hdc, ref User.Struct.RECT lpRect, HANDLE hBrush);
		...
		[DllImport("user32")] public static extern int FrameRect(HDC hdc, ref User.Struct.RECT lpRect, HANDLE hBrush);
		...
		[DllImport("user32")] public static extern int GetCaretPos(ref User.Struct.POINT lpPoint);
		[DllImport("user32")] public static extern int GetClassInfo(HANDLE hInstance, string lpClassName, out User.Struct.WNDCLASS lpWndClass);
		...
		[DllImport("user32")] public static extern int GetClientRect(HWND hwnd, ref User.Struct.RECT lpRect);
		[DllImport("user32")] public static extern int GetClipCursor(out User.Struct.RECT lprc);
		...
		[DllImport("user32")] public static extern int GetCursorPos(out User.Struct.POINT lpPoint);
        ...
        [DllImport("user32")] public static extern int GetDlgCtrlID(IntPtr hwndCtl);
        ...
        [DllImport("user32")] public static extern uint GetDlgItemInt(IntPtr hDlg, int nIDDlgItem, IntPtr lpTranslated, bool bSigned);

		//[DllImport("user32")] public static extern int GetDlgItemText(HANDLE hDlg, int nIDDlgItem, StringBuilder lpString, int nMaxCount);
        [DllImport("user32")] public static extern uint GetDlgItemText(IntPtr hDlg, int nIDDlgItem, [Out] StringBuilder lpString, int nMaxCount);
		...
		[DllImport("user32")] public static extern int GetIconInfo(HANDLE hIcon, out User.Struct.ICONINFO piconinfo);
        ...
        [DllImport("user32")] public static extern bool GetKeyboardState(byte [] lpKeyState);
		...
		[DllImport("user32")] public static extern int GetMenuItemInfo(HANDLE hMenu, int un, int b, ref User.Struct.MENUITEMINFO lpMenuItemInfo);
		[DllImport("user32")] public static extern int GetMenuItemRect(HWND hwnd, HANDLE hMenu, int uItem, ref User.Struct.RECT lprcItem);
		...
		[DllImport("user32")] public static extern int GetMessage(ref User.Struct.MSG lpMsg, HWND hwnd, int wMsgFilterMin, int wMsgFilterMax);
        ...
        [DllImport("user32", ExactSpelling = true, CharSet = CharSet.Auto)] public static extern IntPtr GetParent(IntPtr hWnd);
		...
		[DllImport("user32")] public static extern int GetScrollInfo(HWND hwnd, int n, ref User.Struct.SCROLLINFO lpScrollInfo);
		...
		[DllImport("user32")] public static extern int GetUpdateRect(HWND hwnd, ref User.Struct.RECT lpRect, int bErase);
		...
		[DllImport("user32")] public static extern int GetUserObjectSecurity(HANDLE hObj, ref int pSIRequested, ref Kernel_struct.SECURITY_DESCRIPTOR pSd, int nLength, ref int lpnLengthNeeded);
		[DllImport("user32")] public static extern int GetWindow(HWND hwnd, int wCmd);

        [DllImport("user32")] public static extern bool GetWindowInfo(IntPtr hwnd, ref User.Struct.WINDOWINFO pwi);
		...
		[DllImport("user32")] public static extern int GetWindowPlacement(HWND hwnd, ref User.Struct.WINDOWPLACEMENT lpwndpl);
		[DllImport("user32")] public static extern int GetWindowRect(HWND hwnd, ref User.Struct.RECT lpRect);
        ...
        [DllImport("user32", SetLastError = true)] public static extern uint GetWindowThreadProcessId(IntPtr hWnd, out uint lpdwProcessId);
		...
		[DllImport("user32")] public static extern int InflateRect(ref User.Struct.RECT lpRect, int x, int y);
		...
		[DllImport("user32")] public static extern int InsertMenuItem(HANDLE hMenu, int un, bool b, ref User.Struct.MENUITEMINFO lpcMenuItemInfo);
		[DllImport("user32")] public static extern int IntersectRect(ref User.Struct.RECT lpDestRect, ref User.Struct.RECT lpSrc1Rect, ref User.Struct.RECT lpSrc2Rect);
		[DllImport("user32")] public static extern int InvalidateRect(HWND hwnd, ref User.Struct.RECT lpRect, int bErase);
		[DllImport("user32")] public static extern int InvalidateRgn(HWND hwnd, HANDLE hRgn, int bErase);
		[DllImport("user32")] public static extern int InvertRect(HDC hdc, ref User.Struct.RECT lpRect);
		...
		[DllImport("user32")] public static extern int IsDialogMessage(HANDLE hDlg, ref User.Struct.MSG lpMsg);
		...
		[DllImport("user32")] public static extern int IsRectEmpty(ref User.Struct.RECT lpRect);
		...
		[DllImport("user32")] public static extern int MapDialogRect(HANDLE hDlg, ref User.Struct.RECT lpRect);
		...
		[DllImport("user32")] public static extern int MapWindowPoints(HWND hwndFrom, HWND hwndTo, User.Struct.POINT [] lppt, int cPoints);
		[DllImport("user32")] public static extern int MenuItemFromPoint(HWND hwnd, HANDLE hMenu, User.Struct.POINT ptScreen);
		...
		[DllImport("user32")] public static extern int MessageBoxIndirect(ref User.Struct.MSGBOXPARAMS lpMsgBoxParams);
		...
		[DllImport("user32")] public static extern int OffsetRect(ref User.Struct.RECT lpRect, int x, int y);
		...
		[DllImport("user32")] public static extern int PeekMessage(ref User.Struct.MSG lpMsg, HWND hwnd, int wMsgFilterMin, int wMsgFilterMax, int wRemoveMsg);
		...
		[DllImport("user32")] public static extern int PtInRect(ref User.Struct.RECT lpRect, int ptX, int ptY);
		[DllImport("user32")] public static extern int RedrawWindow(HWND hwnd, ref User.Struct.RECT lprcUpdate, HANDLE hrgnUpdate, int fuRedraw);
		[DllImport("user32")] public static extern int RegisterClass(ref User.Struct.WNDCLASS Class);
		...
		[DllImport("user32")] public static extern int ScreenToClient(HWND hwnd, ref User.Struct.POINT lpPoint);
		[DllImport("user32")] public static extern int ScrollDC(HDC hdc, int dx, int dy, ref User.Struct.RECT lprcScroll, ref User.Struct.RECT lprcClip, HANDLE hrgnUpdate, ref User.Struct.RECT lprcUpdate);
		[DllImport("user32")] public static extern int ScrollWindow(HWND hwnd, int XAmount, int YAmount, ref User.Struct.RECT lpRect, ref User.Struct.RECT lpClipRect);
		[DllImport("user32")] public static extern int ScrollWindowEx(HWND hwnd, int dx, int dy, ref User.Struct.RECT lprcScroll, ref User.Struct.RECT lprcClip, HANDLE hrgnUpdate, ref User.Struct.RECT lprcUpdate, int fuScroll);

		//[DllImport("user32")] public static extern int SendDlgItemMessage(HANDLE hDlg, int nIDDlgItem, int wMsg, int wParam, int lParam);
        [DllImport("user32")] public static extern IntPtr SendDlgItemMessage(IntPtr hDlg, int nIDDlgItem, uint Msg, UIntPtr wParam, IntPtr lParam);

		//[DllImport("user32")] public static extern int SendMessage(HWND hwnd, int wMsg, int wParam, IntPtr lParam);
        //[DllImport("user32", CharSet = CharSet.Auto, SetLastError = false)] public static extern IntPtr SendMessage(HandleRef hWnd, uint Msg, IntPtr wParam, IntPtr lParam);
        [DllImport("user32", CharSet = CharSet.Auto, SetLastError = false)] public static extern IntPtr SendMessage(IntPtr hWnd, uint Msg, IntPtr wParam, IntPtr lParam);
        //[DllImport("user32", CharSet = CharSet.Auto, SetLastError = false)] public static extern IntPtr SendMessage(HandleRef hWnd, uint Msg, IntPtr wParam, StringBuilder lParam);
        [DllImport("user32", CharSet = CharSet.Auto, SetLastError = false)] public static extern IntPtr SendMessage(IntPtr hWnd, uint Msg, IntPtr wParam, StringBuilder lParam);
        //[DllImport("user32", CharSet = CharSet.Auto, SetLastError = false)] public static extern IntPtr SendMessage(HandleRef hWnd, uint Msg, IntPtr wParam, String lParam);
        [DllImport("user32", CharSet = CharSet.Auto, SetLastError = false)] public static extern IntPtr SendMessage(IntPtr hWnd, uint Msg, IntPtr wParam, String lParam);
        ...
        [DllImport("user32")] public static extern bool SetDlgItemText(IntPtr hDlg, int nIDDlgItem, string lpString);
		...
		[DllImport("user32")] public static extern int SetMenuItemInfo(HANDLE hMenu, int un, bool b, ref User.Struct.MENUITEMINFO lpcMenuItemInfo);
		...
		[DllImport("user32")] public static extern int SetRect(ref User.Struct.RECT lpRect, int X1, int Y1, int X2, int Y2);
		[DllImport("user32")] public static extern int SetRectEmpty(ref User.Struct.RECT lpRect);
		[DllImport("user32")] public static extern int SetScrollInfo(HWND hwnd, int n, ref User.Struct.SCROLLINFO lpcScrollInfo, bool redraw);
		...
		[DllImport("user32")] public static extern int SetWindowPlacement(HWND hwnd, ref User.Struct.WINDOWPLACEMENT lpwndpl);
        ...
        // from pinvoke.net (http://www.pinvoke.net/default.aspx/user32/SetWindowsHookEx.html)
        ...
        public delegate int LowLevelKeyboardHookProc(int nCode, WM wParam, [In] User.Struct.KBDLLHOOKSTRUCT lParam);
        public delegate IntPtr LowLevelMouseHookProc(int nCode, WM wParam, [In] User.Struct.MSLLHOOKSTRUCT lParam);
        ...
        [DllImport("user32", SetLastError = true)] public static extern IntPtr SetWindowsHookEx(HookType hookType, HookProc callback, IntPtr hMod, uint dwThreadId);
        /// <summary>The SetWindowsHookEx function installs an application-defined hook procedure into a hook chain. You would install a hook procedure to monitor the system for certain types of events. These events are associated either with a specific thread or with all threads in the same desktop as the calling thread.</summary>
        /// <param name="hookType">Specifies the type of hook procedure to be installed.</param>
        /// <param name="callback">Pointer to the hook procedure. If the dwThreadId parameter is zero or specifies the identifier of a thread created by a different process, the lpfn parameter must point to a hook procedure in a DLL. Otherwise, lpfn can point to a hook procedure in the code associated with the current process.</param>
        /// <param name="hMod">Handle to the DLL containing the hook procedure, hMod parameter must be set to NULL if the dwThreadId parameter specifies a thread that containt the hook procedure</param>
        ...
        [DllImport("user32")] public static extern int CallNextHookEx(IntPtr hhk, int nCode, IntPtr wParam, IntPtr lParam);

        // overload for use with LowLevelKeyboardProc
        [DllImport("user32")] public static extern int CallNextHookEx(IntPtr hhk, int nCode, WM wParam, [In] User.Struct.KBDLLHOOKSTRUCT lParam);

        // overload for use with LowLevelMouseProc
        [DllImport("user32")] public static extern int CallNextHookEx(IntPtr hhk, int nCode, WM wParam, [In] User.Struct.MSLLHOOKSTRUCT lParam);
		...
		[DllImport("user32")] public static extern int SubtractRect(ref User.Struct.RECT lprcDst, ref User.Struct.RECT lprcSrc1, ref User.Struct.RECT lprcSrc2);
		...
		[DllImport("user32")] public static extern int TrackPopupMenu(HANDLE hMenu, int wFlags, int x, int y, int nReserved, HWND hwnd, ref User.Struct.RECT lprc);
		[DllImport("user32")] public static extern int TrackPopupMenuEx(HANDLE hMenu, int un, int n1, int n2, HWND hwnd, ref User.Struct.TPMPARAMS lpTPMParams);
		[DllImport("user32")] public static extern int TranslateAccelerator(HWND hwnd, HANDLE hAccTable, ref User.Struct.MSG lpMsg);
		[DllImport("user32")] public static extern int TranslateMDISysAccel(HWND hwndClient, ref User.Struct.MSG lpMsg);
		[DllImport("user32")] public static extern int TranslateMessage(ref User.Struct.MSG lpMsg);
		...
		[DllImport("user32")] public static extern int UnionRect(ref User.Struct.RECT lpDestRect, ref User.Struct.RECT lpSrc1Rect, ref User.Struct.RECT lpSrc2Rect);
		...
		[DllImport("user32")] public static extern int ValidateRect(HWND hwnd, ref User.Struct.RECT lpRect);
		...
		[DllImport("user32")] public static extern short CascadeWindows(HWND hwndParent, int wHow, ref User.Struct.RECT lpRect, int cKids, ref int lpkids);
		...
		[DllImport("user32")] public static extern short RegisterClassEx(ref User.Struct.WNDCLASSEX pcWndClassEx);
		[DllImport("user32")] public static extern short TileWindows(HWND hwndParent, int wHow, ref User.Struct.RECT lpRect, int cKids, ref int lpKids);
