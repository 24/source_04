...
namespace Test.Test_Form.Test_RunSourceForm.v2
{
    partial class RunSourceForm
    {
        ...
        private DataGridView _gridResult2;
        private DataGrid grid_result3;
        private TreeView tree_result;
        ...
        private void Initialize()
        {
            ...
            if (_version == 1)
            {
                ...
                //CreateXtraGrid();
                _gridResult1 = zXtraGrid.Create();
                _gridView1 = (GridView)_gridResult1.MainView;
                _gridResult1.Dock = DockStyle.Fill;
                tab_result1.Controls.Add(_gridResult1);

                //CreateDataGridView();
                _gridResult2 = zDataGridView.Create();
                _gridResult2.Dock = DockStyle.Fill;
                tab_result2.Controls.Add(_gridResult2);

                //CreateDataGrid();
                grid_result3 = zForm.CreateDataGrid();
                grid_result3.Dock = DockStyle.Fill;
                tab_result3.Controls.Add(grid_result3);

                //CreateTreeView();
                tree_result = new TreeView();
                tree_result.Dock = DockStyle.Fill;
                tab_result4.Controls.Add(tree_result);

                tb_message = zForm.CreateTextBox(multiline: true);
                tb_message.Dock = DockStyle.Fill;
                tab_message.Controls.Add(tb_message);
            }
            ...
            if (_version == 2)
            {
                ...
                _gridView1 = (GridView)_gridResult1.MainView;
                _gridResult1.Dock = DockStyle.Fill;
                pan_tab_result1.Controls.Add(_gridResult1);

                _gridResult2 = zDataGridView.Create();
                _gridResult2.Dock = DockStyle.Fill;
                pan_tab_result2.Controls.Add(_gridResult2);

                grid_result3 = zForm.CreateDataGrid();
                grid_result3.Dock = DockStyle.Fill;
                pan_tab_result3.Controls.Add(grid_result3);

                tree_result = new TreeView();
                tree_result.Dock = DockStyle.Fill;
                pan_tab_result4.Controls.Add(tree_result);

                tb_message = zForm.CreateTextBox(multiline: true);
                tb_message.Dock = DockStyle.Fill;
                pan_tab_result5.Controls.Add(tb_message);
            }
        ...
        private void CreateForm()
        {
            ...
            if (pan_status_v2 != null)
                this.Controls.Add(pan_status_v2);
            if (tc_result != null)
                this.Controls.Add(tc_result);
            if (pan_result_v2 != null)
        ...
        private void CreatePanTop()
        {
            ...
            pan_top.Size = new Size(1056, 300);  // 197
        ...
        private void CreatePanButton()
        {
            ...
            bt_execute = zForm.CreateButton("&Run", x: 3, y: 3, width: 75, height: 23);
            bt_pause = zForm.CreateButton("&Pause", x: 87, y: 3, width: 75, height: 23);
            bt_stop = zForm.CreateButton("&Stop", x: 171, y: 3, width: 75, height: 23);
