...
namespace Test.Test_Form.Test_RunSourceForm.v2
{
    ...
    {
        //public static void Test_Form_01()
        //{
        //    Form1 form1 = new Form1();
        //    form1.Show();
        //}

        public static void Test_RunSourceForm_01(int version)
        {
            RunSourceForm form = new RunSourceForm(version);
            form.Show();
        }

        //public static void Test_RunSourceForm_v2_01()
        //{
        //    //RunSourceFormBase_v2 form = new RunSourceFormBase_v2();
        //    ////Trace.WriteLine("ClientSize.Width {0} ClientSize.Height {1}", form.ClientSize.Width, form.ClientSize.Height);
        //    //form.FormWidth = 1060;
        //    //form.FormHeight = 650;
        //    //CreateMenu(form.MainMenuStrip);
        //    //form.Initialize();
        //    ////Trace.WriteLine("ClientSize.Width {0} ClientSize.Height {1}", form.ClientSize.Width, form.ClientSize.Height);
        //    RunSourceForm_v2 form = new RunSourceForm_v2();
