...
namespace Test.Test_OpenXml
{
    public static class Test_OpenXml_05
    {
        ...
        public static IEnumerable<OXmlElement> GetDocXElements_01()
        {
            ...
            yield return new OXmlPictureElement { File = pictureDir + "112509336.jpg", Description = "Baloo va t il etre soigne", Width = 300, PictureDrawing = new OXmlPictureInlineDrawing() };
            yield return new OXmlElement { Type = OXmlElementType.Paragraph };
