...
namespace pb.Windows.Forms
{
    ...
    public static class ScintillaExtension
    {
        ...
        // length : max number of character in line number. ex : 4 => 9999 lines
        public static void zDisplayLineNumber(this Scintilla scintilla, int length)
        {
            ...
            const int padding = 2;
            scintilla.Margins[ScintillaMargin.LineNumber].Width = scintilla.TextWidth(Style.LineNumber, new string('9', length + 1)) + padding;
        }
