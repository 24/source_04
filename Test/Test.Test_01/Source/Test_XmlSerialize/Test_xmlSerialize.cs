...
XmlSerialize(new Test_05() { id = 1, name = "toto", test = new Test_01() { id = 2, name = "tata", addressType = AddressType.Bill | AddressType.Ship } },
  "test_05_01.xml");
/********** result
***********/


_rs.View(Get_EnumTest_01());
XmlSerialize(Get_EnumTest_01(), "EnumTest_01_01.xml");
_rs.View(XmlDeserialize<EnumTest_01>("EnumTest_01_01.xml"));
