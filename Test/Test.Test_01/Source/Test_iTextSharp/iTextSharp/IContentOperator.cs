...
/*
 * $Id: IContentOperator.cs 318 2012-02-27 22:46:07Z psoares33 $
 *
...
namespace Test_iTextSharp
{
    ...
    public interface IContentOperator {
         ...
         */
        void Invoke(PdfContentStreamProcessor processor, PdfLiteral oper, List<iTextSharp.text.pdf.PdfObject> operands);
