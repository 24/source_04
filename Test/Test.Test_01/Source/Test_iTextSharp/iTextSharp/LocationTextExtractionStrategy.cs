...
/*
 * $Id: LocationTextExtractionStrategy.cs 427 2012-09-24 12:10:30Z dkoleda $
 *
...
namespace Test_iTextSharp
{
    ...
    {
        public List<TextChunk> text = new List<TextChunk>();
        public TextBlock parent = null;
        public List<TextBlock> childs = new List<TextBlock>();

        public string GetText()
        {
            StringBuilder sb = new StringBuilder();
            bool first = true;
            foreach (TextChunk chunk in text)
            {
                if (first)
                    first = false;
                else
        ...
        public string[] GetTextByLines(int maxCol)
        {
     ...
     * @since   5.0.2
     */
    // 'Test_iTextSharp.LocationTextExtractionStrategy' does not implement interface member 'iTextSharp.text.pdf.parser.IRenderListener.RenderText(iTextSharp.text.pdf.parser.TextRenderInfo)'
    public class LocationTextExtractionStrategy : ITextExtractionStrategy {
        ...
        public virtual void BeginTextBlock(){
            ...
            {
                textBlock.parent = currentTextBlock;
                currentTextBlock.childs.Add(textBlock);
            }
            else
        ...
        public virtual void EndTextBlock(){
            currentTextBlock = currentTextBlock.parent;
        }
