...
/*
 * $Id: PdfContentStreamProcessor.cs 424 2012-09-12 09:37:52Z dkoleda $
 *
...
namespace Test_iTextSharp
{
    ...
    public class PdfContentStreamProcessor {
         ...
         */
        private void InvokeOperator(PdfLiteral oper, List<iTextSharp.text.pdf.PdfObject> operands)
        {
            IContentOperator op;
            ...
            //else
            //    if (w.log) w._tr.WriteLine("operator type {0} string {1}", op.GetType().ToString(), oper.ToString());
         ...
         * @since 2.1.7
         */
        //'iTextSharp.text.pdf.parser.GraphicsState' does not contain a definition for 'font' and no extension method 'font' accepting a first argument of type 
        //'iTextSharp.text.pdf.parser.GraphicsState' could be found (are you missing a using directive or an assembly reference?)
        ...
        private void BeginText(){
            //if (w.log) w._tr.WriteLine("BeginTextBlock");
        ...
        private void EndText(){
            //if (w.log) w._tr.WriteLine("EndTextBlock");
