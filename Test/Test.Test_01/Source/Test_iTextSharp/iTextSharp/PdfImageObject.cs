...
namespace Test_iTextSharp
{
    ...
    public class PdfImageObject {
         ...
         * @throws IOException
         */
        public PdfImageObject(PRStream stream, PdfDictionary colorSpaceDic) : this(stream, iTextSharp.text.pdf.PdfReader.GetStreamBytesRaw(stream), colorSpaceDic) {
        }
        ...
        protected internal PdfImageObject(PdfDictionary dictionary, byte[] samples, PdfDictionary colorSpaceDic)  {
            ...
            imageBytes = iTextSharp.text.pdf.PdfReader.DecodeBytes(samples, dictionary, handlers);
